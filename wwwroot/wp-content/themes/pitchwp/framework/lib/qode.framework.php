...
class QodePitchFramework {
    ...
    private function __construct() {
        $this->qodeOptions = QodePitchOptions::get_instance();
        $this->qodeMetaBoxes = QodePitchMetaBoxes::get_instance();
    }
	...
	public function setSkin(QodePitchSkinAbstract $skinObject) {
		$this->skin = $skinObject;
	}
}

/**
 * Class QodePitchSkinManager
 *
...
class QodePitchSkinManager {
    ...
    /**
     * @see QodePitchSkinManager::setSkin()
     */
    ...
    private function setSkin($skinName = 'select') {
        if($skinName !== '') {
            if(file_exists(get_template_directory().'/framework/admin/skins/'.$skinName.'/skin.php')) {
                ...
                $skinName = ucfirst($skinName).'PitchSkin';
...
/**
 * Class QodePitchSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class QodePitchSkinAbstract {
    /**
     * @var string
     */
    protected $skinName;
    ...
    public function setShortcodeJSParams() { ?>
		<script>
			window.qodeSCIcon = '<?php echo qode_pitch_get_skin_uri().'/assets/img/admin-logo-icon.png'; ?>';
...
/*
   Class: QodePitchAdminPage
   A class that initializes Qode Admin Page
*/
class QodePitchAdminPage implements iLayoutNode {
    ...
    function __construct($slug="", $title="", $icon = "") {
        $this->layout = array();
        $this->factory = new QodePitchFieldFactory();
        $this->slug = $slug;
        $this->title = $title;
        $this->icon = $icon;
    }
...
/*
   Class: QodePitchMetaBox
   A class that initializes Qode Meta Box
*/
class QodePitchMetaBox implements iLayoutNode {
	...
	public function setTitle($label) {
		...
		return $qode_pitch_Framework->getSkin()->getSkinLabel().' '.$label;
 	}
}

global $qode_pitch_Framework;

$qode_pitch_Framework = QodePitchFramework::get_instance();
$qodeSkinManager = new QodePitchSkinManager();
$qode_pitch_Framework->setSkin($qodeSkinManager->getSkin());