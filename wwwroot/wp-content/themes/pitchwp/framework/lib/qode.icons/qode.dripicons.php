...
/**
 * Class QodePitchDripicons
 */
class QodePitchDripicons implements iIconPitchCollection {
    /**
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="qode_icon_dripicons dripicon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
