                        ...
                        <div class="qodef-page-form-section-holder">
                            ...
                            <div class="qodef-page-form-section">
                                ...
                                <div class="qodef-section-content">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="import_load"><span><?php esc_html_e('The import process may take some time. Please be patient.', 'pitchwp') ?> </span><br />
                            ...
                            <div class="qodef-page-form-section qodef-import-button-wrapper">
                                ...
                                <div class="alert alert-warning">
                                    <strong><?php esc_html_e('Important notes:', 'pitchwp') ?></strong>
                                    <ul>
                                        <li><?php esc_html_e('Please note that import process will take time needed to download all attachments from demo web site.', 'pitchwp'); ?></li>
                                        <li> <?php esc_html_e('If you plan to use shop, please install WooCommerce before you run import.', 'pitchwp')?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
