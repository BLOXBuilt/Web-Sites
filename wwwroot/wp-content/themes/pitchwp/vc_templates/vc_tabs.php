...
$output .= "</div>";
if ('vc_tour' == $this->shortcode) {
    $output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __('Previous slide', 'pitchwp') . '">' . esc_html__('Previous slide', 'pitchwp') . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . esc_html__('Next slide', 'pitchwp') . '">' . esc_html__('Next slide', 'pitchwp') . '</a></span></div>';
}
