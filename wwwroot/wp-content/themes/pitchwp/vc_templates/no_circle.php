...
if($background_color != "") {
    if($background_transparency !="") {
        $bg_color = qode_pitch_hex2rgb($background_color);
...
$html .= '<div class="q_circle_inner_holder"><div class="q_circle_inner'. $border_class.' " style="'.$circle_wrapper_style.'"><div class="q_circle_inner2 '.$image_with_text_class.'" style="'.$circle_style.' '.$image_with_text_style.'">';
...
$html .= '</div>';
$html .= '</div>';
$html .= '<span class="q_circle_arrow fa fa-long-arrow-right"></span>';
$html .= '</div>';
