...
if($show_content_border == "yes"){
	...
	$tabs_container_style .= 'border: 1px solid;';
...
$output .= "\n\t\t\t" . $tabs_nav;
$output .= '<div class="tabs-container" '.qode_pitch_get_inline_style($tabs_container_style).'>';
$output .= "\n\t\t\t" . wpb_js_remove_wpautop($content);
$output .= "</div>";
if ('vc_tour' == $this->shortcode) {
    $output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . esc_html__('Previous slide', 'pitchwp') . '">' . esc_html__('Previous slide', 'pitchwp') . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . esc_html__('Next slide', 'pitchwp') . '">' . esc_html__('Next slide', 'pitchwp') . '</a></span></div>';
}
