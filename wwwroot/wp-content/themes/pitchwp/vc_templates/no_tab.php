...
$default_attrs = array_merge($qode_pitch_IconCollections->getShortcodeParams(), $default_attrs);
...
if(isset($icon_pack) && $icon_pack !== '') {
	...
	$collection_obj = $qode_pitch_IconCollections->getIconCollection($icon_pack);
...
$output .= ($content=='' || $content==' ') ? esc_html__("Empty section. Edit page to add content here.", "pitchwp") : "\n\t\t\t\t" . wpb_js_remove_wpautop($content);
