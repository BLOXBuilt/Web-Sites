...
if(get_post_meta($id, "qode_page_background_color", true) != ""){
    $content_style .= 'background-color: '.esc_attr(get_post_meta($id, "qode_page_background_color", true));
}

if(isset($qode_pitch_options['blog_standard_type_number_of_chars']) && $qode_pitch_options['blog_standard_type_number_of_chars'] != "") {
    qode_pitch_set_blog_word_count(13);
}
...
<?php get_template_part('slider'); ?>
    ...
    <div class="container" <?php qode_pitch_inline_style($content_style); ?>>
