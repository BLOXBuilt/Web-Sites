...
$show_hover_image = 'no';
if(isset($qode_pitch_options['woo_products_enable_item_hover_image'])){
	$show_hover_image = $qode_pitch_options['woo_products_enable_item_hover_image'];
}

$woo_products_enable_lighbox_icon_yes_no = "yes";

if(isset($qode_pitch_options['woo_products_enable_lighbox_icon'])){
	$woo_products_enable_lighbox_icon_yes_no =  $qode_pitch_options['woo_products_enable_lighbox_icon'];
}

$hide_separator = "no";
if(isset($qode_pitch_options['woo_products_title_separator_hide_title_separator'])){
	$hide_separator = $qode_pitch_options['woo_products_title_separator_hide_title_separator'];
}
		...
		<?php do_action( 'woocommerce_before_shop_loop_item' ); ?>
			<div class="top-product-section">
				...
				<div class="product_list_button_holder">
					<?php do_action('qode_pitch_woocommerce_after_product_image'); ?>
					<div class="woocommerce_single_product_link_holder">
						<a class="qbutton woocommerce_single_product_link" href="<?php the_permalink(); ?>"> View <span class="fa-search"></span> </a>
						<a class="qbutton woocommerce_single_product_link double" href="<?php the_permalink(); ?>"> View <span class="fa-search"></span> </a>
					</div>
				</div>
			</div>
