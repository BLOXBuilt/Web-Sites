<?php 
global $qode_pitch_options, $qode_pitch_IconCollections;
...
if(get_post_meta($id, "qode_responsive-title-image", true) != ""){
 $responsive_title_image = get_post_meta($id, "qode_responsive-title-image", true);
	...
	$responsive_title_image = $qode_pitch_options['responsive_title_image'];
}

if(get_post_meta($id, "qode_fixed-title-image", true) != ""){
 $fixed_title_image = get_post_meta($id, "qode_fixed-title-image", true);
}else{
	$fixed_title_image = $qode_pitch_options['fixed_title_image'];
}
...
if(get_post_meta($id, "qode_title-image", true) != ""){
    ...
    $title_image = $qode_pitch_options['title_image'];
}
$title_image_height = "";
$title_image_width = "";
if($title_image !== ''){
	$title_image_dimensions_array = qode_pitch_get_image_dimensions($title_image);
...
elseif($qode_pitch_options['title_graphics'] != "") {
    $title_graphics = $qode_pitch_options['title_graphics'];
}
...
elseif (get_post_meta($id, 'page_page_title_whole_content_animations', true) == '' && isset($qode_pitch_options['page_title_whole_content_animations']) && $qode_pitch_options['page_title_whole_content_animations'] !== '') {
    $title_content_animation = $qode_pitch_options['page_title_whole_content_animations'];
}
...
if ($title_content_animation == 'yes') {
    ...
    if (get_post_meta($id, 'page_page_title_whole_content_data_start', true) == '' && isset($qode_pitch_options['page_title_whole_content_data_start']) && $qode_pitch_options['page_title_whole_content_data_start'] !== '') {
        $page_title_content_data_start = $qode_pitch_options['page_title_whole_content_data_start'];
    ...
    if (get_post_meta($id, 'page_page_title_whole_content_start_custom_style', true) == '' && isset($qode_pitch_options['page_title_whole_content_start_custom_style']) && $qode_pitch_options['page_title_whole_content_start_custom_style'] !== '') {
        $page_title_content_start_custom_style = $qode_pitch_options['page_title_whole_content_start_custom_style'];
    ...
    if (get_post_meta($id, 'page_page_title_whole_content_data_end', true) == '' && isset($qode_pitch_options['page_title_whole_content_data_end']) && $qode_pitch_options['page_title_whole_content_data_end'] !== '') {
        $page_title_content_data_end = $qode_pitch_options['page_title_whole_content_data_end'];
    ...
    if (get_post_meta($id, 'page_page_title_whole_content_end_custom_style', true) == '' && isset($qode_pitch_options['page_title_whole_content_end_custom_style']) && $qode_pitch_options['page_title_whole_content_end_custom_style'] !== '') {
        $page_title_content_end_custom_style = $qode_pitch_options['page_title_whole_content_end_custom_style'];
...
elseif (get_post_meta($id, 'page_page_title_graphic_animations', true) == '' && isset($qode_pitch_options['page_title_graphic_animations']) && $qode_pitch_options['page_title_graphic_animations'] !== '') {
    $graphic_animation = $qode_pitch_options['page_title_graphic_animations'];
}
...
if ($title_graphics !== '' && $graphic_animation == 'yes'){
    ...
    if (get_post_meta($id, 'page_page_title_graphic_data_start', true) == '' && isset($qode_pitch_options['page_title_graphic_data_start']) && $qode_pitch_options['page_title_graphic_data_start'] !== '') {
        $page_title_graphic_data_start = $qode_pitch_options['page_title_graphic_data_start'];
    ...
    if(get_post_meta($id, 'page_page_title_graphic_start_custom_style', true) == '' && isset($qode_pitch_options['page_title_graphic_start_custom_style']) && $qode_pitch_options['page_title_graphic_start_custom_style'] !== '') {
        $page_title_graphic_start_custom_style = $qode_pitch_options['page_title_graphic_start_custom_style'];
    ...
    if(get_post_meta($id, 'page_page_title_graphic_data_end', true) == '' && isset($qode_pitch_options['page_title_graphic_data_end']) && $qode_pitch_options['page_title_graphic_data_end'] !== '') {
        $page_title_graphic_data_end = $qode_pitch_options['page_title_graphic_data_end'];
    ...
    if(get_post_meta($id, 'page_page_title_graphic_end_custom_style', true) == '' && isset($qode_pitch_options['page_title_graphic_end_custom_style']) && $qode_pitch_options['page_title_graphic_end_custom_style'] !== '') {
        $page_title_graphic_end_custom_style = $qode_pitch_options['page_title_graphic_end_custom_style'];
...
if(get_post_meta($id, "qode_title-overlay-image", true) != ""){
 $title_overlay_image = get_post_meta($id, "qode_title-overlay-image", true);
	...
	$title_overlay_image = $qode_pitch_options['title_overlay_image'];
}
...
if(isset($qode_pitch_options['enable_header_top_border']) && $qode_pitch_options['enable_header_top_border']=='yes' && isset($qode_pitch_options['header_top_border_width']) && $qode_pitch_options['header_top_border_width']!==''){
    $header_top_border = esc_attr($qode_pitch_options['header_top_border_width']);
}
if(isset($qode_pitch_options['enable_header_bottom_border']) && $qode_pitch_options['enable_header_bottom_border']=='yes' && isset($qode_pitch_options['header_bottom_border_width']) && $qode_pitch_options['header_bottom_border_width']!==''){
    $header_bottom_border = esc_attr($qode_pitch_options['header_bottom_border_width']);
}

$header_centered_logo_border = 0;
if(isset($qode_pitch_options['center_logo_image']) && $qode_pitch_options['center_logo_image'] == "yes" && isset($qode_pitch_options['enable_border_top_bottom_menu']) && $qode_pitch_options['enable_border_top_bottom_menu'] == "yes"){
    $header_centered_logo_border = 2;
}

$header_height = 90;
if (!empty($qode_pitch_options['header_height']) && $header_bottom_appearance != "fixed_hiding") {
    $header_height = esc_attr($qode_pitch_options['header_height']);
} elseif($header_bottom_appearance == "fixed_hiding"){
    $header_height = 90 + $logo_height/2 + 40; // 40 is top and bottom margin of logo
} elseif(isset($qode_pitch_options['center_logo_image']) && $qode_pitch_options['center_logo_image'] == "yes" && $header_bottom_appearance == "fixed") {
...
if($qode_pitch_options['header_bottom_appearance'] == 'stick menu_bottom'){
    $menu_bottom = 60;
...
$header_top = 0;
if(isset($qode_pitch_options['header_top_area']) && $qode_pitch_options['header_top_area'] == "yes"){
	if(isset($qode_pitch_options['header_top_height']) && $qode_pitch_options['header_top_height'] !== ""){
		$header_top = $qode_pitch_options['header_top_height'];
	} else {
		$header_top = 36;
	}
}
...
}elseif(get_post_meta($id, "qode_page_page_title_vertical_aligment", true) == '' && (isset($qode_pitch_options['page_title_vertical_aligment']) && $qode_pitch_options['page_title_vertical_aligment'] == 'header_bottom')) {
	$title_vertical_alignment = 'header_bottom';
} elseif(get_post_meta($id, "qode_page_page_title_vertical_aligment", true) == '' && (isset($qode_pitch_options['page_title_vertical_aligment']) && $qode_pitch_options['page_title_vertical_aligment'] == 'window_top')) {
	$title_vertical_alignment = 'window_top';
}
...
if ($header_bottom_appearance != "fixed" && $header_bottom_appearance != "fixed_hiding" && $header_bottom_appearance != "regular") {
    if ($qode_pitch_options['center_logo_image'] != "yes") {
...
if (!empty($qode_pitch_options['header_height'])) {
    if($header_bottom_appearance == "fixed_hiding") {
        $header_height_padding =  esc_attr($qode_pitch_options['header_height']) + $header_top + $logo_height/2 + 40 + $header_top_border + $header_bottom_border + $header_centered_logo_border; // 40 is top and bottom margin of logo
    } elseif($qode_pitch_options['center_logo_image'] == "yes"){
        if($header_bottom_appearance == "fixed") {
            if ($qode_pitch_options['header_height'] > $logo_height) {
                $header_height_padding = esc_attr($qode_pitch_options['header_height']) + $header_top + $logo_height + 20 + $header_top_border + $header_bottom_border + $header_centered_logo_border; // 20 is top margin of logo
            } else {
                $header_height_padding = (esc_attr($qode_pitch_options['header_height'])) * 2 + $header_top + 20 + $header_top_border + $header_bottom_border + $header_centered_logo_border; // 20 is top margin of logo
            }
        }
        if($header_bottom_appearance == "stick"){
            $header_height_padding = (20 + $logo_height/2 + esc_attr($qode_pitch_options['header_height']) + $header_top + $header_top_border + $header_bottom_border + $header_centered_logo_border); // 20 is top margin of centered logo
        }
    } else {
        if($header_bottom_appearance != "stick menu_bottom") {
            $header_height_padding = esc_attr($qode_pitch_options['header_height']) + $header_top + $header_top_border + $header_bottom_border + $header_centered_logo_border;
        }
    }
}
...
if(get_post_meta($id, "qode_page_title_type", true) != ""){
    ...
    if(isset($qode_pitch_options['title_type'])){
...
if(get_post_meta($id, "qode_page_subtitle_position", true) != ""){
    ...
    if(isset($qode_pitch_options['subtitle_position'])){
        $subtitle_position = $qode_pitch_options['subtitle_position'];
    }
}
...
} elseif(get_post_meta($id, "qode_show-page-title", true) == '' && (isset($qode_pitch_options['show_page_title']) && $qode_pitch_options['show_page_title'] == 'yes')) {
	$is_title_area_visible = true;
} elseif(get_post_meta($id, "qode_show-page-title", true) == '' && (isset($qode_pitch_options['show_page_title']) && $qode_pitch_options['show_page_title'] == 'no')) {
	$is_title_area_visible = false;
} elseif(isset($qode_pitch_options['show_page_title']) && $qode_pitch_options['show_page_title'] == 'yes') {
	$is_title_area_visible = true;
}
...
elseif (get_post_meta($id, 'page_page_title_animations', true) == '' && isset($qode_pitch_options['page_title_animations']) && $qode_pitch_options['page_title_animations'] !== '') {
    $title_animation = $qode_pitch_options['page_title_animations'];
}
...
if($is_title_text_visible && $title_animation == 'yes') {
    ...
    if(get_post_meta($id, 'page_page_title_data_start', true) == '' && isset($qode_pitch_options['page_title_data_start']) && $qode_pitch_options['page_title_data_start'] !== '') {
        $page_title_data_start = $qode_pitch_options['page_title_data_start'];
    ...
    if(get_post_meta($id, 'page_page_title_start_custom_style', true) == '' && isset($qode_pitch_options['page_title_start_custom_style']) && $qode_pitch_options['page_title_start_custom_style'] !== '') {
        $page_title_start_custom_style = $qode_pitch_options['page_title_start_custom_style'];
    ...
    if(get_post_meta($id, 'page_page_title_data_end', true) == '' && isset($qode_pitch_options['page_title_data_end']) && $qode_pitch_options['page_title_data_end'] !== '') {
        $page_title_data_end = $qode_pitch_options['page_title_data_end'];
    } elseif(get_post_meta($id, 'page_page_title_data_end', true) !== '') {
        $page_title_data_end = get_post_meta($id, 'page_page_title_data_end', true);
    }

    if(get_post_meta($id, 'page_page_title_end_custom_style', true) == '' && isset($qode_pitch_options['page_title_end_custom_style']) && $qode_pitch_options['page_title_end_custom_style'] !== '') {
        $page_title_end_custom_style = $qode_pitch_options['page_title_end_custom_style'];
...
if(get_post_meta($id, "qode_header_color_transparency_per_page", true) === "" || qode_pitch_is_default_wp_template()) {
...
if(isset($qode_pitch_options['header_bottom_appearance']) && ($qode_pitch_options['header_bottom_appearance'] == "stick" || $qode_pitch_options['header_bottom_appearance'] == "stick menu_bottom" || $qode_pitch_options['header_bottom_appearance'] == "stick_with_left_right_menu")){
...
}elseif($qode_pitch_options['title_height'] != ''){
	$title_height = esc_attr($qode_pitch_options['title_height']);
}
//is header solid?
if(!$is_header_solid && !$is_header_initially_hidden && $qode_pitch_options['header_bottom_appearance'] != 'regular' && get_post_meta($id, "qode_enable_content_top_margin", true) != "yes"){
//	if ((isset($qode_pitch_options['center_logo_image']) && $qode_pitch_options['center_logo_image'] == "yes") || $qode_pitch_options['header_bottom_appearance'] == 'fixed_hiding') {
//		if($qode_pitch_options['header_bottom_appearance'] == 'stick menu_bottom'){
//	        $title_height = $title_height + $header_height + $header_top + $logo_height + 20; // 20 is top margin of centered logo
//	    } elseif($qode_pitch_options['header_bottom_appearance'] == 'fixed_hiding' || $qode_pitch_options['header_bottom_appearance'] == 'fixed'){
//	        if(!empty($qode_pitch_options['header_height']) && $qode_pitch_options['header_bottom_appearance'] == "fixed"){
//	        	$title_height = $title_height + $qode_pitch_options['header_height'] + $header_top + $logo_height + 20;
//	        } else {
...
if(get_post_meta($id, "qode_page-title-background-color", true) != ""){
    ...
    $title_background_color = esc_attr($qode_pitch_options['title_background_color']);
}
...
if(get_post_meta($id, "qode_page_title_style", true) != ""){
    ...
    if(isset($qode_pitch_options['title_style'])) {
        $qode_page_title_style = $qode_pitch_options['title_style'];
    } else {
        $qode_page_title_style = "standard";
    }
}
...
if(get_post_meta($id, "qode_animate_page_title", true) != ""){
    ...
    $animate_title_area = $qode_pitch_options['animate_title_area'];
}
...
if(qode_pitch_is_side_header() && isset($qode_pitch_options['paspartu']) && $qode_pitch_options['paspartu'] == 'no'){
    ...
    if(get_post_meta($id, "qode_title-height", true) != ""){
        ...
        $title_height = esc_attr(get_post_meta($id, "qode_title-height", true));
    }else if($qode_pitch_options['title_height'] != ''){
        $title_holder_height = $qode_pitch_options['title_height'];
        $title_height = esc_attr($qode_pitch_options['title_height']);
    }
...
}elseif(isset($qode_pitch_options['enable_breadcrumbs'])){
	$enable_breadcrumbs = $qode_pitch_options['enable_breadcrumbs'];
}
...
elseif (get_post_meta($id, 'page_page_title_breadcrumbs_animations', true) == '' && isset($qode_pitch_options['page_title_breadcrumbs_animations']) && $qode_pitch_options['page_title_breadcrumbs_animations'] !== '') {
    $breadcrumbs_animation = $qode_pitch_options['page_title_breadcrumbs_animations'];
}
...
if($enable_breadcrumbs == 'yes' && $breadcrumbs_animation == 'yes') {
    ...
    if(get_post_meta($id, 'page_page_title_breadcrumbs_data_start', true) == '' && isset($qode_pitch_options['page_title_breadcrumbs_data_start']) && ($qode_pitch_options['page_title_breadcrumbs_data_start'] !== '')) {
        $page_title_breadcrumbs_data_start = $qode_pitch_options['page_title_breadcrumbs_data_start'];
    ...
    if(get_post_meta($id, 'page_page_title_breadcrumbs_start_custom_style', true) == '' && isset($qode_pitch_options['page_title_breadcrumbs_start_custom_style']) && ($qode_pitch_options['page_title_breadcrumbs_start_custom_style'] !== '')) {
        $page_title_breadcrumbs_start_custom_style = $qode_pitch_options['page_title_breadcrumbs_start_custom_style'];
    ...
    if(get_post_meta($id, 'page_page_title_breadcrumbs_data_end', true) == '' && isset($qode_pitch_options['page_title_breadcrumbs_data_end']) && ($qode_pitch_options['page_title_breadcrumbs_data_end'] !== '')) {
        $page_title_breadcrumbs_data_end = $qode_pitch_options['page_title_breadcrumbs_data_end'];
    ...
    if(get_post_meta($id, 'page_page_title_breadcrumbs_end_custom_style', true) == '' && isset($qode_pitch_options['page_title_breadcrumbs_end_custom_style']) && ($qode_pitch_options['page_title_breadcrumbs_end_custom_style'] !== '')) {
        $page_title_breadcrumbs_end_custom_style = $qode_pitch_options['page_title_breadcrumbs_end_custom_style'];
...
if(get_post_meta($id, "qode_title_text_shadow", true) != ""){
	...
	if($qode_pitch_options['title_text_shadow'] == "yes"){
		$title_text_shadow = ' title_text_shadow';
	}
}
$subtitle_color ="";
...
if (is_tag()) {
	...
	$title = esc_html__('Author:', 'pitchwp').get_the_author();
}elseif (is_category()){
	$title = single_cat_title('', false);
}elseif (is_home()){
	$title = get_option('blogname');
}elseif (is_search()){
    $title = esc_html__('Results for', 'pitchwp').': '.get_search_query();
}elseif (is_404()){
	if($qode_pitch_options['404_title'] != "") {
		$title = $qode_pitch_options['404_title'];
	} else { 
		$title = esc_html__('404 - Page not found', 'pitchwp');
	}
	...
	$title = esc_html__('Archive','pitchwp');
}else {
...
if (get_post_meta($id,"qode_title_like_separator",true) == "yes" || (isset($qode_pitch_options['title_like_separator']) && $qode_pitch_options['title_like_separator']=='yes' && get_post_meta($id,"qode_title_like_separator",true) != "no")) {
...
if ($title_like_separator) {
    ...
    elseif (isset($qode_pitch_options['page_title_position']) && !empty($qode_pitch_options['page_title_position'])) {
        $title_shortcode .= ' text_position = "' . $qode_pitch_options['page_title_position'] . '"';
    }
    ...
    elseif (isset($qode_pitch_options['title_like_separator_line_color']) && !empty($qode_pitch_options['title_like_separator_line_color'])) {
        $title_shortcode .= ' line_color = "' . $qode_pitch_options['title_like_separator_line_color'] . '"';
    }
    ...
    elseif (isset($qode_pitch_options['title_like_separator_line_width']) && !empty($qode_pitch_options['title_like_separator_line_width'])) {
        $title_shortcode .= ' line_width = "' . $qode_pitch_options['title_like_separator_line_width'] . '"';
    }
    ...
    elseif (isset($qode_pitch_options['title_like_separator_line_thickness']) && !empty($qode_pitch_options['title_like_separator_line_thickness'])) {
        $title_shortcode .= ' line_thickness = "' . $qode_pitch_options['title_like_separator_line_thickness'] . '"';
    }
    ...
    elseif (isset($qode_pitch_options['title_like_separator_line_style']) && !empty($qode_pitch_options['title_like_separator_line_style'])) {
        $title_shortcode .= ' line_border_style = "' . $qode_pitch_options['title_like_separator_line_style'] . '"';
    }
    ...
    elseif (isset($qode_pitch_options['title_like_separator_margins']) && !empty($qode_pitch_options['title_like_separator_margins'])) {
        $title_shortcode .= ' box_margin = "' . $qode_pitch_options['title_like_separator_margins'] . '"';
    }
    ...
    elseif (isset($qode_pitch_options['title_like_separator_line_dots']) && !empty($qode_pitch_options['title_like_separator_line_dots'])) {
        $title_shortcode .= ' line_dots = "' . $qode_pitch_options['title_like_separator_line_dots'] . '"';
        if ($qode_pitch_options['title_like_separator_line_dots'] == "yes") {
            $title_like_separator_dots = true;
        }
    }
    ...
    if ($title_like_separator_dots) {          
        ...
        elseif (isset($qode_pitch_options['title_like_separator_dots_size']) && !empty($qode_pitch_options['title_like_separator_dots_size'])) {
            $title_shortcode .= ' line_dots_size = "' . $qode_pitch_options['title_like_separator_dots_size'] . '"';
        }
        ...
        elseif (isset($qode_pitch_options['title_like_separator_dots_color']) && !empty($qode_pitch_options['title_like_separator_dots_color'])) {
            $title_shortcode .= ' line_dots_color = "' . $qode_pitch_options['title_like_separator_dots_color'] . '"';
        }
    }
    ...
    if (get_post_meta($id,'qode_title_background_color',true) != "") {
        $title_span_background_color_rgb = qode_pitch_hex2rgb(esc_attr(get_post_meta($id, 'qode_title_background_color', true)));
    }
...
if (get_post_meta($id,"qode_subtitle_like_separator",true) == "yes" || (isset($qode_pitch_options['subtitle_like_separator']) && $qode_pitch_options['subtitle_like_separator']=='yes' && get_post_meta($id,"qode_subtitle_like_separator",true) != "no")) {
...
if ($subtitle_like_separator) {
    ...
    elseif (isset($qode_pitch_options['page_title_position']) && !empty($qode_pitch_options['page_title_position'])) {
        $subtitle_shortcode .= ' text_position = "' . $qode_pitch_options['page_title_position'] . '"';
    }
    ...
    elseif (isset($qode_pitch_options['subtitle_like_separator_line_color']) && !empty($qode_pitch_options['subtitle_like_separator_line_color'])) {
        $subtitle_shortcode .= ' line_color = "' . $qode_pitch_options['subtitle_like_separator_line_color'] . '"';
    }
    ...
    elseif (isset($qode_pitch_options['subtitle_like_separator_line_width']) && !empty($qode_pitch_options['subtitle_like_separator_line_width'])) {
        $subtitle_shortcode .= ' line_width = "' . $qode_pitch_options['subtitle_like_separator_line_width'] . '"';
    }
    ...
    elseif (isset($qode_pitch_options['subtitle_like_separator_line_thickness']) && !empty($qode_pitch_options['subtitle_like_separator_line_thickness'])) {
        $subtitle_shortcode .= ' line_thickness = "' . $qode_pitch_options['subtitle_like_separator_line_thickness'] . '"';
    }
    ...
    elseif (isset($qode_pitch_options['subtitle_like_separator_line_style']) && !empty($qode_pitch_options['subtitle_like_separator_line_style'])) {
        $subtitle_shortcode .= ' line_border_style = "' . $qode_pitch_options['subtitle_like_separator_line_style'] . '"';
    }
    ...
    elseif (isset($qode_pitch_options['subtitle_like_separator_margins']) && !empty($qode_pitch_options['subtitle_like_separator_margins'])) {
        $subtitle_shortcode .= ' box_margin = "' . $qode_pitch_options['subtitle_like_separator_margins'] . '" ';
    }
    ...
    if (get_post_meta($id,'qode_subtitle_background_color',true) != "") {
        $subtitle_span_background_color_rgb = qode_pitch_hex2rgb(esc_attr(get_post_meta($id, 'qode_subtitle_background_color', true)));
    }
...
$separator_animation = '';
if (get_post_meta($id,'qode_title_separator',true) == "yes"  || (!empty($qode_pitch_options['title_separator']) && $qode_pitch_options['title_separator']=='yes' && get_post_meta($id,'qode_title_separator',true) != "no")) {
    $title_separator = "yes";
    ...
    elseif (isset($qode_pitch_options['title_separator_position']) && $qode_pitch_options['title_separator_position'] == "above") {
        $title_separator_position_vertical = "above";
    }
    ...
    elseif ($qode_pitch_options['title_separator_format'] == "with_icon" || $qode_pitch_options['title_separator_format'] == "with_custom_icon") {
        $with_icon = true;
    }
    ...
    if ($with_icon) {
        ...
        if (get_post_meta($id,'qode_title_separator_format',true) != "") {
            ...
            $separator_shortcode_params .= ' type = "' . $qode_pitch_options['title_separator_format'] . '" ';
        }

        if (get_post_meta($id,'qode_title_separator_format',true) == "with_custom_icon" || (get_post_meta($id,'qode_title_separator_format',true) == "" && $qode_pitch_options['title_separator_format'] == "with_custom_icon")) {
            ...
            elseif (isset($qode_pitch_options['separator_custom_icon']) && !empty($qode_pitch_options['separator_custom_icon'])) {
                $separator_shortcode_params .= ' custom_icon ="' . $qode_pitch_options['separator_custom_icon'] . '" ';
            }
        }
        else {
            if (get_post_meta($id,'qode_separator_icon_pack',true) != "") {
                $separator_shortcode_params .= $qode_pitch_IconCollections->iconPackParamName.'="'.get_post_meta($id,'qode_separator_icon_pack',true).'"';

                $icon_collection = $qode_pitch_IconCollections->getIconCollection(get_post_meta($id,'qode_separator_icon_pack',true));
            ...
            elseif (isset($qode_pitch_options['separator_icon_pack']) && !empty($qode_pitch_options['separator_icon_pack'])) {

                $separator_shortcode_params .= $qode_pitch_IconCollections->iconPackParamName.'="'.$qode_pitch_options['separator_icon_pack'].'"';

                $icon_collection = $qode_pitch_IconCollections->getIconCollection($qode_pitch_options['separator_icon_pack']);

                if(is_object($icon_collection) && isset($qode_pitch_options['separator_icon_'.$icon_collection->param]) && !empty($qode_pitch_options['separator_icon_'.$icon_collection->param])) {
                    $separator_shortcode_params .= ' '.$icon_collection->param.'="'.$qode_pitch_options['separator_icon_'.$icon_collection->param].'"';
                }
            }
            ...
            elseif (isset($qode_pitch_options['title_separator_icon_hover_color']) && !empty($qode_pitch_options['title_separator_icon_hover_color'])) {
                $separator_shortcode_params .= ' hover_icon_color = "'.$qode_pitch_options['title_separator_icon_hover_color'].'"';
            }
            ...
            elseif (isset($qode_pitch_options['title_separator_icon_color']) && !empty($qode_pitch_options['title_separator_icon_color'])) {
                $separator_shortcode_params .= ' icon_color = "'.$qode_pitch_options['title_separator_icon_color'].'"';
            }
            ...
            elseif (isset($qode_pitch_options['title_separator_icon_custom_size']) && !empty($qode_pitch_options['title_separator_icon_custom_size'])) {
                $separator_shortcode_params .= ' icon_custom_size = "'.$qode_pitch_options['title_separator_icon_custom_size'].'"';
            }
            ...
            elseif (isset($qode_pitch_options['title_separator_icon_type']) && !empty($qode_pitch_options['title_separator_icon_type'])) {
                $separator_shortcode_params .= ' icon_type = "'.$qode_pitch_options['title_separator_icon_type'].'"';
                $separator_type = $qode_pitch_options['title_separator_icon_type'];
            }
            ...
            if ($separator_type != "normal"){
                ...
                elseif (isset($qode_pitch_options['title_separator_icon_border_radius']) && !empty($qode_pitch_options['title_separator_icon_border_radius'])) {
                    $separator_shortcode_params .= ' icon_border_radius = "'.$qode_pitch_options['title_separator_icon_border_radius'].'"';
                }
                ...
                elseif (isset($qode_pitch_options['title_separator_icon_border_width']) && !empty($qode_pitch_options['title_separator_icon_border_width'])) {
                    $separator_shortcode_params .= ' icon_border_width = "'.$qode_pitch_options['title_separator_icon_border_width'].'"';
                }
                ...
                elseif (isset($qode_pitch_options['title_separator_icon_border_color']) && !empty($qode_pitch_options['title_separator_icon_border_color'])) {
                    $separator_shortcode_params .= ' icon_border_color = "'.$qode_pitch_options['title_separator_icon_border_color'].'"';
                }
                ...
                elseif (isset($qode_pitch_options['title_separator_icon_border_hover_color']) && !empty($qode_pitch_options['title_separator_icon_border_hover_color'])) {
                    $separator_shortcode_params .= ' hover_icon_border_color = "'.$qode_pitch_options['title_separator_icon_border_hover_color'].'"';
                }
                ...
                elseif (isset($qode_pitch_options['title_separator_icon_shape_size']) && !empty($qode_pitch_options['title_separator_icon_shape_size'])) {
                    $separator_shortcode_params .= ' icon_shape_size = "'.$qode_pitch_options['title_separator_icon_shape_size'].'"';
                }
                ...
                elseif (isset($qode_pitch_options['title_separator_icon_background_color']) && !empty($qode_pitch_options['title_separator_icon_background_color'])) {
                    $separator_shortcode_params .= ' icon_background_color = "'.$qode_pitch_options['title_separator_icon_background_color'].'"';
                }
                ...
                elseif (isset($qode_pitch_options['title_separator_icon_background_hover_color']) && !empty($qode_pitch_options['title_separator_icon_background_hover_color'])) {
                    $separator_shortcode_params .= ' hover_icon_background_color = "'.$qode_pitch_options['title_separator_icon_background_hover_color'].'"';
                }
            }
        }
        ...
        elseif (isset($qode_pitch_options['title_separator_color']) && !empty($qode_pitch_options['title_separator_color'])) {
            $separator_shortcode_params .= ' color = "'.$qode_pitch_options['title_separator_color'].'"';
        }
        ...
        elseif (isset($qode_pitch_options['title_separator_type']) && !empty($qode_pitch_options['title_separator_type'])) {
            $separator_shortcode_params .= ' border_style = "'.$qode_pitch_options['title_separator_type'].'"';
        }
        ...
        elseif (isset($qode_pitch_options['title_separator_thickness']) && !empty($qode_pitch_options['title_separator_thickness'])) {
            $separator_shortcode_params .= ' thickness = "'.$qode_pitch_options['title_separator_thickness'].'"';
        }
        ...
        elseif (isset($qode_pitch_options['title_separator_width']) && !empty($qode_pitch_options['title_separator_width'])) {
            $separator_shortcode_params .= ' width = "'.$qode_pitch_options['title_separator_width'].'"';
        }
        ...
        elseif (isset($qode_pitch_options['title_separator_topmargin']) && !empty($qode_pitch_options['title_separator_topmargin'])) {
            $separator_shortcode_params .= ' up = "'.$qode_pitch_options['title_separator_topmargin'].'"';
        }
        ...
        elseif (isset($qode_pitch_options['title_separator_bottommargin']) && !empty($qode_pitch_options['title_separator_bottommargin'])) {
            $separator_shortcode_params .= ' down = "'.$qode_pitch_options['title_separator_bottommargin'].'"';
        }
        ...
        elseif (isset($qode_pitch_options['title_separator_icon_position']) && !empty($qode_pitch_options['title_separator_icon_position'])) {
            $separator_shortcode_params .= ' separator_icon_position = "'.$qode_pitch_options['title_separator_icon_position'].'"';
        }
        ...
        elseif (isset($qode_pitch_options['title_separator_icon_margins']) && !empty($qode_pitch_options['title_separator_icon_margins'])) {
            $separator_shortcode_params .= ' icon_margin = "'.$qode_pitch_options['title_separator_icon_margins'].'"';
        }
    }
		...
		elseif(isset($qode_pitch_options['page_title_position']) && !empty($qode_pitch_options['page_title_position'])) {
			$separator_title_position = $qode_pitch_options['page_title_position'];
		}
		...
		elseif(!empty($qode_pitch_options['title_separator_color'])){
			$title_separator_style .= 'border-color:'.esc_attr($qode_pitch_options['title_separator_color']).';';
		}
		...
		elseif(isset($qode_pitch_options['title_separator_thickness']) && !empty($qode_pitch_options['title_separator_thickness'])) {
			$title_separator_style .= 'border-width: ' . esc_attr($qode_pitch_options['title_separator_thickness']) . 'px 0 0;';
		}
		...
		elseif(isset($qode_pitch_options['title_separator_width']) && !empty($qode_pitch_options['title_separator_width'])) {
			$title_separator_style .= 'width: ' . esc_attr($qode_pitch_options['title_separator_width']) . 'px;';
		}
		...
		elseif(isset($qode_pitch_options['title_separator_topmargin']) && !empty($qode_pitch_options['title_separator_topmargin'])) {
			$title_separator_style .= 'margin-top: ' . esc_attr($qode_pitch_options['title_separator_topmargin']) . 'px;';
		}
		...
		elseif(isset($qode_pitch_options['title_separator_bottommargin']) && !empty($qode_pitch_options['title_separator_bottommargin'])) {
			$title_separator_style .= 'margin-bottom: ' . esc_attr($qode_pitch_options['title_separator_bottommargin']) . 'px;';
		}
		...
		elseif(isset($qode_pitch_options['title_separator_type']) && !empty($qode_pitch_options['title_separator_type'])) {
			$title_separator_style .= 'border-style: ' . esc_attr($qode_pitch_options['title_separator_type']) . ';';
		}
    }
    ...
    elseif($qode_pitch_options['page_title_separator_animations'] && $qode_pitch_options['page_title_separator_animations'] !== '') {
        $separator_animation = $qode_pitch_options['page_title_separator_animations'];
    }
    ...
    if($separator_animation == 'yes') {
        ...
        if(get_post_meta($id, 'page_page_title_separator_data_start', true) == '' && isset($qode_pitch_options['page_title_separator_data_start']) && $qode_pitch_options['page_title_separator_data_start'] !== '') {
            $page_title_separator_data_start = $qode_pitch_options['page_title_separator_data_start'];
        ...
        if(get_post_meta($id, 'page_page_title_separator_start_custom_style', true) == '' && isset($qode_pitch_options['page_title_separator_start_custom_style']) && $qode_pitch_options['page_title_separator_start_custom_style'] !== '') {
            $page_title_separator_start_custom_style = $qode_pitch_options['page_title_separator_start_custom_style'];
        ...
        if(get_post_meta($id, 'page_page_title_separator_data_end', true) == '' && isset($qode_pitch_options['page_title_separator_data_end']) && $qode_pitch_options['page_title_separator_data_end'] !== '') {
            $page_title_separator_data_end = $qode_pitch_options['page_title_separator_data_end'];
        ...
        if(get_post_meta($id, 'page_page_title_separator_end_custom_style', true) == '' && isset($qode_pitch_options['page_title_separator_end_custom_style']) && $qode_pitch_options['page_title_separator_end_custom_style'] !== '') {
            $page_title_separator_end_custom_style = $qode_pitch_options['page_title_separator_end_custom_style'];
...
if (get_post_meta($id,'qode_title_area_content_background_color',true) != "") {
    $title_area_content_background_color_rgb = qode_pitch_hex2rgb(esc_attr(get_post_meta($id, 'qode_title_area_content_background_color', true)));
}
...
if (get_post_meta($id,'qode_title_content_top_padding',true) != "") {
	$title_area_content_padding .= 'padding-top: ' . esc_attr(get_post_meta($id,'qode_title_content_top_padding',true)). 'px; ';
}
if (get_post_meta($id,'qode_title_content_right_padding',true) != "") {
	$title_area_content_padding .= 'padding-right: ' . esc_attr(get_post_meta($id,'qode_title_content_right_padding',true)). 'px; ';
}
if (get_post_meta($id,'qode_title_content_bottom_padding',true) != "") {
	$title_area_content_padding .= 'padding-bottom: ' . esc_attr(get_post_meta($id,'qode_title_content_bottom_padding',true)). 'px; ';
}
if (get_post_meta($id,'qode_title_content_left_padding',true) != "") {
	$title_area_content_padding .= 'padding-left: ' . esc_attr(get_post_meta($id,'qode_title_content_left_padding',true)). 'px; ';
}
...
if (get_post_meta($id, 'qode_page_subtitle', true) !== '') {
    ...
    elseif (isset($qode_pitch_options['page_subtitle_animations']) && $qode_pitch_options['page_subtitle_animations'] !== '') {
        $subtitle_animation = $qode_pitch_options['page_subtitle_animations'];
    }
    ...
    if ($subtitle_animation == 'yes') {
        ...
        if(get_post_meta($id, 'page_page_subtitle_data_start', true) == '' && isset($qode_pitch_options['page_subtitle_data_start']) && ($qode_pitch_options['page_subtitle_data_start'] !== '')) {
            $page_subtitle_data_start = $qode_pitch_options['page_subtitle_data_start'];
        ...
        if(get_post_meta($id, 'page_page_subtitle_start_custom_style', true) == '' && isset($qode_pitch_options['page_subtitle_start_custom_style']) && ($qode_pitch_options['page_subtitle_start_custom_style'] !== '')) {
            $page_subtitle_start_custom_style = $qode_pitch_options['page_subtitle_start_custom_style'];
        ...
        if(get_post_meta($id, 'page_page_subtitle_data_end', true) == '' && isset($qode_pitch_options['page_subtitle_data_end']) && ($qode_pitch_options['page_subtitle_data_end'] !== '')) {
            $page_subtitle_data_end = $qode_pitch_options['page_subtitle_data_end'];
        ...
        if(get_post_meta($id, 'page_page_subtitle_end_custom_style', true) == '' && isset($qode_pitch_options['page_subtitle_end_custom_style']) && ($qode_pitch_options['page_subtitle_end_custom_style'] !== '')) {
            $page_subtitle_end_custom_style = $qode_pitch_options['page_subtitle_end_custom_style'];
...
if($is_title_area_visible) { ?>
	<div class="title_outer <?php echo esc_attr($animate_title_class.$title_text_shadow); if($responsive_title_image == 'yes' && $show_title_image == true && $title_image !== ''){ echo ' with_image'; }?>" <?php echo esc_attr($animation); ?> <?php echo 'data-height="'.esc_attr($title_height).'"'; if($title_height != '' && $animate_title_area == 'area_top_bottom'){ echo ' style="opacity:0; height:0px;"'; } ?>>
		<div class="title <?php qode_pitch_title_classes(); ?>" style="<?php if($responsive_title_image == 'no' && $title_image != "" && $show_title_image == true){ if($title_image_width != ''){ echo 'background-size:'.esc_attr($title_image_width).'px auto;'; } echo 'background-image:url('.esc_url($title_image).');';  } if($title_height != ''){ echo 'height:'.esc_attr($title_height).'px;'; } if($title_background_color != ''){ echo 'background-color:'.esc_attr($title_background_color).';'; } ?>">
			...
			<div class="title_holder" <?php print $page_title_content_animation_data; ?> <?php if($responsive_title_image != 'yes'){ qode_pitch_inline_style($title_holder_height); } ?>>
				<div class="container clearfix">
					<div class="container_inner clearfix">
						<div class="title_subtitle_holder <?php echo esc_attr($title_content_classes); ?>" <?php if($title_image !== '' && $responsive_title_image == 'yes' && $show_title_image == true){ qode_pitch_inline_style($title_subtitle_padding); } if($title_content_classes !== ""){ qode_pitch_inline_style($title_area_style); } ?>>
                            <?php if($qode_pitch_options['overlapping_content'] == 'yes') {?><div class="overlapping_content_margin"><?php } ?>
							...
							<div class="title_subtitle_holder_inner title_content_background" <?php qode_pitch_inline_style($title_area_style); ?>>
							<?php } ?>
								<?php if($title_type != "breadcrumbs_title") { ?>
									...
									<?php if($subtitle_position=="above_title"){?>
										<?php if(get_post_meta($id, "qode_page_subtitle", true) != ""){ 
												if ($subtitle_like_separator){?>
												<span class="subtitle subtitle_like_separator <?php echo esc_attr($subtitle_in_box); ?>" <?php qode_pitch_inline_style($subtitle_color); ?>><span class="span_subtitle_separator" <?php print $page_subtitle_animation_data; ?> > <?php echo do_shortcode($subtitle_shortcode); // XSS OK ?></span></span>
												<?php }
												else {
											?>
												<span class="subtitle" <?php qode_pitch_inline_style($subtitle_color); ?>><span <?php print $page_subtitle_animation_data; ?> <?php qode_pitch_inline_style($subtitle_span_style); ?>><?php echo wp_kses_post(get_post_meta($id, "qode_page_subtitle", true)); ?></span></span>
										<?php }
										} ?>
									<?php } ?>
                                    ...
                                    <?php if($title_separator == "yes" && $title_separator_position_vertical == "above"){
                                            ...
                                            <?php }
                                                ...
                                                <span class="separator small <?php echo esc_attr($separator_title_position); ?>" <?php qode_pitch_inline_style($title_separator_style); ?>  <?php print $page_title_separator_animation_data; ?>></span>
                                            <?php } ?>
                                    <?php } ?>
                                    ...
                                    <?php if($is_title_text_visible) {
                                            if ($subtitle_position == "next_to_title" && get_post_meta($id, "qode_page_subtitle", true) != ""){?>
                                                <h1<?php print $page_title_animation_data; if(get_post_meta($id, "qode_page-title-color", true)) { ?> style="color:<?php echo esc_attr(get_post_meta($id, "qode_page-title-color", true)); ?>" <?php } ?>><span <?php qode_pitch_inline_style($title_span_style); ?>><?php echo wp_kses_post($title); ?></span></h1>
                                                <span class="subtitle next_to_title" <?php qode_pitch_inline_style($subtitle_color); ?>><span <?php print $page_subtitle_animation_data; ?> <?php qode_pitch_inline_style($subtitle_span_style); ?>><?php echo wp_kses_post(get_post_meta($id, "qode_page_subtitle", true)); ?></span></span>
                                        <?php }
                                            else{
                                                if($title_like_separator){ ?>
								...
								<?php } ?>
									...
									<?php if (function_exists('qode_pitch_custom_breadcrumbs') && $enable_breadcrumbs == "yes") { ?>
										<div class="breadcrumb" <?php print $page_title_breadcrumbs_animation_data; ?>> <?php qode_pitch_custom_breadcrumbs(); ?></div>
									<?php } ?>
							...
							<?php } ?>
                                <?php if($qode_pitch_options['overlapping_content'] == 'yes') {?></div><?php } ?>
						</div>
					</div>
				</div>
			</div>
