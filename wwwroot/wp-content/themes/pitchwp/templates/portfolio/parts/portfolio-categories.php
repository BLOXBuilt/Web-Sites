...
if(isset($qode_pitch_options['portfolio_hide_categories'])) {
	$portfolio_hide_categories = $qode_pitch_options['portfolio_hide_categories'];
}
...
if(is_array($portfolio_categories) && count($portfolio_categories) && $portfolio_hide_categories != "yes"){
	...
	<div class="info portfolio_single_categories">
		<<?php echo esc_attr($portfolio_info_tag); ?> class="info_section_title" <?php qode_pitch_inline_style($portfolio_info_style); ?>><?php esc_html_e('Category:','pitchwp'); ?></<?php echo esc_attr($portfolio_info_tag); ?>>
		<p>
			<span class="category">
