...
if(is_array($portfolio_tags) && count($portfolio_tags)) {
	...
	<div class="info portfolio_single_tags">
		<<?php echo esc_attr($portfolio_info_tag);?> class="info_section_title" <?php qode_pitch_inline_style($portfolio_info_style); ?>><?php esc_html_e('Tags:', 'pitchwp') ?></<?php echo esc_attr($portfolio_info_tag);?>>
		<span class="category">
