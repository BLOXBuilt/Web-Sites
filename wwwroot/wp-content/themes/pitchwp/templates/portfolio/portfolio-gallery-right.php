...
if (isset($qode_pitch_options['portfolio_text_follow'])) {
    $portfolio_text_follow = esc_attr($qode_pitch_options['portfolio_text_follow']);
}
...
} elseif(isset($qode_pitch_options['portfolio_columns_number']) && $qode_pitch_options['portfolio_columns_number'] !== '') {
	$columns_number = 'v'.$qode_pitch_options['portfolio_columns_number'];
}
