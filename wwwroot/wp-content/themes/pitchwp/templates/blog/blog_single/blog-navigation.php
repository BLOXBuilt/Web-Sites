...
if (isset($qode_pitch_options['blog_single_navigation']) && $qode_pitch_options['blog_single_navigation'] == "yes"){
    $enable_blog_navigation = true;
}

$navigation_blog_through_category = false;
if (isset($qode_pitch_options['blog_navigation_through_same_category']) && $qode_pitch_options['blog_navigation_through_same_category'] == "yes")
