...
if (!qode_pitch_vc_grid_elements_enabled() && version_compare(qode_pitch_get_vc_version(), '4.4.2') >= 0) {
...
if (function_exists('vc_remove_param')) {
	...
	if(version_compare(qode_pitch_get_vc_version(), '4.4.2') >= 0) {
	...
	if(version_compare(qode_pitch_get_vc_version(), '4.7.4') >= 0) {
		add_action( 'init', 'qode_pitch_remove_vc_image_zoom',11);
		function qode_pitch_remove_vc_image_zoom() {
...
if (function_exists('vc_remove_param') && qode_pitch_vc_grid_elements_enabled() && version_compare(qode_pitch_get_vc_version(), '4.4.2') >= 0) {
...
vc_add_param("vc_tab", array(
    ...
    "class" => "",
    "heading" => "Icon Pack",
    "param_name" => $qode_pitch_IconCollections->iconPackParamName,
    "value" => $qode_pitch_IconCollections->getIconCollectionsVC(),
	'save_always' => true,
));
...
foreach ($qode_pitch_IconCollections->iconCollections as $collection_key => $collection ) {
    vc_add_param("vc_tab", array(
		...
		'save_always' => true,
        "dependency" => Array('element' => $qode_pitch_IconCollections->iconPackParamName, 'value' => array($collection_key))
    ));
}
...
vc_add_param("vc_row", array(
	"type" => "attach_image",
	"class" => "",
	"heading" => "Floating Background Image",
	"param_name" => "floating_image",
	"value" => "",
	"description" => "For better effect, choose a smaller image, as its multiple instances will float around.",
	"dependency" => Array('element' => "row_type", 'value' => array('row'))
));
...
vc_add_param("vc_row", array(
	"type" => "textfield",
	"class" => "",
	"heading" => "Speed of Floating",
	"param_name" => "floating_speed",
	"value" => "3",
	"description" => "How many pixels per second floating images move.",
	"dependency" => Array('element' => "floating_image", 'not_empty' => true)
));
...
vc_add_param("vc_row", array(
	...
	'save_always' => true,
	"description" => "\"Yes\" will cause half of the images to float in opposite direction.",
	"dependency" => Array('element' => "floating_image", 'not_empty' => true)
));
...
vc_add_param("vc_row", array(
	"type" => "dropdown",
	"class" => "",
	"heading" => "Random Sized Floating Images",
	...
	'save_always' => true,
	"description" => "\"Yes\" renders the floating image in random sizes.",
	"dependency" => Array('element' => "floating_image", 'not_empty' => true)
));
...
vc_add_param("vc_row", array(
	...
	"value" => array_merge(array('' => ''), array_flip(qode_pitch_get_custom_sidebars())),
	"description" => "",
	"dependency" => Array('element' => "row_type", 'value' => array('content_menu'))
));
...
vc_add_param("vc_row_inner", array(
	...
	'save_always' => true,
	"description" => "\"Yes\" will cause half of the images to float in oppostie direction.",
	"dependency" => Array('element' => "floating_image", 'not_empty' => true)
));
...
vc_add_param("vc_text_separator", array(
    ...
    "description" => esc_html__("Insert border radius(Rounded corners) in px. For example: 4. Leave empty for default. ", 'pitchwp'),
    "dependency" => Array('element' => "text_in_box", 'value' => array('yes'))
));
...
vc_add_param("vc_single_image",  array(
	...
	"value" => array(
        "No Animation" => "",
        "Grayscale to Color" => "grayscale_to_color"
    ),
	'save_always' => true,
	"description" => "" 
));
...
function qode_pitch_add_open_prettyphoto() {
    ...
    $param['value'][esc_html__('Open prettyPhoto', 'pitchwp')] = 'open_prettyphoto';
    //Finally "mutate" param with new values
    WPBMap::mutateParam('vc_single_image', $param);
}
add_action('init', 'qode_pitch_add_open_prettyphoto',11);
...
vc_map( array(
	"name" =>  esc_html__( 'Elements Holder', 'pitchwp' ),
...
vc_map( array(
	"name" =>  esc_html__( 'Elements Holder Item', 'pitchwp' ),
...
vc_map( array(
	'name' => esc_html__( 'Bordered Elements Holder', 'pitchwp' ),
	...
	"params" => array_merge(
        array(
            array(
		        ...
		        "class" => "",
				"admin_label" => true,
                "heading" => esc_html__("Type", 'pitchwp'),
                "param_name" => "type",
                "value" => array(
                    "Image in left box" => "image_in_box",
                    "Boxes" => "boxes",
                    "Post Over Image" => "post_over_image",
                    "Image With Date" => "image_with_date",
                    "Minimal" => "minimal",
                    "Split column" => "split_column",
                    "Date in Left Section" => "date_in_left_section",
                    "Masonry" => "masonry"
                ),
				'save_always' => true,
                "description" => ""
            ...
            array(
                "type" => "dropdown",
                "class" => "",
                "heading" => "Vertical Alignment of text",
            ...
            array(
                ...
                "type" => "dropdown",
                "class" => "",
                "heading" => "Border Around Post Info",
        ...
        $qode_pitch_IconCollections->getVCParamsArray( array( 'element' => 'display_button', 'value' => '1' ) ),
        array(
            array(
                "type" => "dropdown",
                "class" => "",
				...
				'save_always' => true,
                "dependency" => Array('element' => $qode_pitch_IconCollections->iconPackParamName, 'not_empty' => true)
            ),
            array(
                "type" => "colorpicker",
                "holder" => "div",
...
vc_map( array(
	"name" =>  esc_html__( 'Select Vertical Split Slider', 'pitchwp' ),
...
vc_map( array(
	"name" =>  esc_html__( 'Left Sliding Panel', 'pitchwp' ),
...
vc_map( array(
	"name" =>  esc_html__( 'Right Sliding Panel', 'pitchwp' ),
...
vc_map( array(
	"name" =>  esc_html__( 'Slide Content Item', 'pitchwp' ),
...
vc_map( array(
	"name" =>  esc_html__( 'Select Vertical Split Slider With Text Over', 'pitchwp' ),
...
vc_map( array(
	"name" =>  esc_html__( 'Left Panel', 'pitchwp' ),
...
vc_map( array(
	"name" =>  esc_html__( 'Right Panel', 'pitchwp' ),
...
for ($x = 1; $x<6; $x++) {
	$teamIconCollections = $qode_pitch_IconCollections->getCollectionsWithSocialIcons();
	...
	$team_social_icons_array[] = array(
		...
		"dependency" => array('element' => 'team_social_icon_pack', 'value' => $qode_pitch_IconCollections->getIconCollectionsKeys())
	);
	...
	"params" => array_merge(
		array(
			...
			array(
				...
				"value" => array_merge(array("" => ""),$qode_pitch_IconCollections->getIconCollectionsVCExclude(array('linea_icons','dripicons'))),
				'save_always' => true,
			...
			array(
				...
				"value" => array(
					...
					"On the bottom of the image" => "social_style_bottom"
				),
				'save_always' => true,
...
vc_map( array(
	...
	"params" => array_merge(
		...
		$qode_pitch_IconCollections->getVCParamsArray(),
		array(
			array(
				"type" => "dropdown",
				"holder" => "div",
...
vc_map( array(
	...
	"params" => array_merge(
		...
		$qode_pitch_IconCollections->getVCParamsArray( array( 'element' => 'type', 'value' => array( 'icon_type' ) ) ),
		array(
			array(
				"type" => "textfield",
				"holder" => "div",
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"holder" => "div",
			"class" => "",
			"heading" => "Title Border Bottom Style",
			"param_name" => "title_border_bottom_style",
			"value" => array(
				"In grid" => "pricing_title_grid",
				"Full Width" => "pricing_title_full_width"
			),
			'save_always' => true,
			"description" => "",
		...
		array(
			...
			"holder" => "div",
			"class" => "",
			"heading" => "Price Border Bottom Color",
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "item_padding",
			"value" => "",
			"description" =>  esc_html__("Please insert padding in format 0px 10px 0px 10px, default value is 0 0 0 0", 'pitchwp')
		),
		array(
			"type" => "dropdown",
			"holder" => "div",
...
vc_map( array(
		...
		"params" => array_merge(
			...
			$qode_pitch_IconCollections->getVCParamsArray(array("element" => "header_type", "value" => array("with_icon"))),
			array(
				array(
					"type" => "colorpicker",
					"holder" => "div",
...
$call_to_action_button_IconCollections = $qode_pitch_IconCollections->iconCollections;
...
vc_map( array(
		...
		"params" => array_merge(
			...
			$qode_pitch_IconCollections->getVCParamsArray(array('element' => 'type', 'value' => array('with_icon'))),
			array(
				array(
					"type" => "attach_image",
					"holder" => "div",
                ...
                array(
                    ...
                    "value" => array_merge(array("No Icon" => ""),$qode_pitch_IconCollections->getIconCollectionsVC()),
					'save_always' => true
                )
            ),
	...
	"params" => array_merge(
		...
		array(
			...
			array(
				...
				"heading" => "Icon Size",
				"param_name" => "icon_size",
				"value" => $qode_pitch_IconCollections->getIconSizesArray(),
				'save_always' => true,
				"description" => "",
				"dependency" => Array('element' => "type", 'value' => array('with_icon'))
			),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "padding",
			"value" => "0",
			"description" =>  esc_html__("Please insert padding in format (top right bottom left) i.e. 5px 5px 5px 5px", 'pitchwp')
		),
		array(
			"type" => "textfield",
			"holder" => "div",
			...
			"param_name" => "margin",
			"value" => "0",
			"description" =>  esc_html__("Please insert margin in format (top right bottom left) i.e. 5px 5px 5px 5px", 'pitchwp')
		),
		array(
			"type" => "dropdown",
			"holder" => "div",
...
vc_map( array(
	...
	"params" => array(
		array(
			...
			"param_name" => "number",
			"value" => "",
			"description" =>  esc_html__("Insert a number", 'pitchwp')
		),
		array(
			"type" => "textfield",
			"holder" => "div",
			...
			"param_name" => "title",
			"value" => "",
			"description" =>  esc_html__("Insert title", 'pitchwp')
		),
		array(
			"type" => "textfield",
			"holder" => "div",
			...
			"param_name" => "subtitle",
			"value" => "",
			"description" =>  esc_html__("Insert subtitle", 'pitchwp')
		),
		array(
			"type" => "dropdown",
			"holder" => "div",
			"class" => "",
			"heading" => "Show Animation",
			"param_name" => "animation",
			"value" => array(
				"No" => "no",
				"Yes" => "yes"
		...
		array(
			...
			"param_name" => "animation_delay",
			"value" => "",
			"description" =>  esc_html__("Insert transition delay in seconds", 'pitchwp'),
...
vc_map( array(
		...
		"params" => array_merge(
                    ...
                    $qode_pitch_IconCollections->getVCParamsArray(array(), '', true),
                    array(
                        array(
                            "type" => "dropdown",
                            "holder" => "div",
                        ...
                        array(
                            ...
                            "heading" => "Margin",
                            "param_name" => "margin",
                            "description" => esc_html__("Please insert margin in format: 0px 0px 1px 0px", 'pitchwp')
                        ),
                        array(
                            "type" => "textfield",
                            "holder" => "div",
                            ...
                            "heading" => "Left/Right Padding (px)",
                            "param_name" => "padding",
                            "description" => "For transparent style affects only space between icon and text",
                        ),
                        array(
                            "type" => "textfield",
                            "holder" => "div",
                            ...
                            "param_name" => "border_radius",
                            "description" => esc_html__("Please insert border radius(Rounded corners) in px. For example: 4 ", 'pitchwp'),
                            "dependency" => array('element' => 'style', 'value' => array("","white"))
                        )
                    )
                )
...
vc_map( array(
	...
	"base" => "no_counter",
	"category" => 'by Select',
	'admin_enqueue_css' => array(qode_pitch_get_skin_uri().'/assets/css/qodef-vc-extend.css'),
	...
	"params" => array_merge(
		...
		$qode_pitch_IconCollections->getVCParamsArray(array("element" => "counter_icon", "value" => array("yes"))),
		array(
			array(
				"type" => "colorpicker",
				"holder" => "div",
				...
				"heading" => "Icon Color",
				"param_name" => "icon_color",
				"dependency" => Array('element' => "icon_pack", 'value' => $qode_pitch_IconCollections->getIconCollectionsKeys())
			),
			array(
				"type" => "textfield",
				"holder" => "div",
...
for ($x = 1; $x<4; $x++) {
    $coverBoxesCollections = $qode_pitch_IconCollections->iconCollections;
...
vc_map( array(
		...
		"params" => array_merge(
                    ...
                    $qode_pitch_IconCollections->getVCParamsArray((array('element' => "show_icon", 'value' => array('always', 'on_hover', 'before_hover'))), '', true),
                    array(
                        array(
                            "type" => "dropdown",
                            "holder" => "div",
						...
						array(
							...
							"holder" => "div",
							"class" => "",
							"heading" => "Small Title Text",
							"param_name" => "small_title",
							"description" => "This text is displayed above the title.",
							"dependency" => Array('element' => "show_title", 'value' => array('always','on_hover','before_hover'))
						),
                        array(
                            "type" => "dropdown",
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			'save_always' => true,
			"description" => "Underline title text on hover.",
			"dependency" => array('element' => "text_over_image", 'value' => array("yes"))
		),
		array(
			"type" => "dropdown",
...
vc_map( array(
	"name" =>  esc_html__( 'Select Tabs', 'pitchwp' ),
	"base" => "no_tabs",
...
vc_map( array(
	"name" =>  esc_html__( 'Select Tab', 'pitchwp' ),
	"base" => "no_tab",
	"as_parent" => array('except' => 'vc_row'),
...
vc_map( array(
		"name" =>  esc_html__( 'Select Accordion', 'pitchwp' ),
		"base" => "no_accordion",
		...
		"params" => array(
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Active section', 'pitchwp' ),
				'param_name' => 'active_tab',
				'value' => 1,
				'description' => esc_html__( 'Enter section number to be active on load or enter "false" to collapse all sections.', 'pitchwp' )
			),
			array(
				'type' => 'checkbox',
				'heading' => esc_html__( 'Allow collapse all sections?', 'pitchwp' ),
				'param_name' => 'collapsible',
				'description' => esc_html__( 'If checked, it is allowed to collapse all sections.', 'pitchwp' ),
				'value' => array( esc_html__( 'Yes', 'pitchwp' ) => 'yes' )
			),
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Extra class name', 'pitchwp' ),
				'param_name' => 'el_class',
				'description' => esc_html__( 'Style particular content element differently - add a class name and refer to it in custom CSS.', 'pitchwp' )
			),
			array(
				"type" => "dropdown",
				"class" => "",
...
vc_map( array(
	"name" =>  esc_html__( 'Select Accordion Tab', 'pitchwp' ),
	...
	"params" => array_merge(
		array(
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Title', 'pitchwp' ),
				'param_name' => 'title',
				'admin_label' => true,
				'value' => esc_html__( 'Section', 'pitchwp' ),
				'description' => esc_html__( 'Enter accordion section title.', 'pitchwp' )
			),
			array(
				'type' => 'el_id',
				'heading' => esc_html__( 'Section ID', 'pitchwp' ),
				'param_name' => 'el_id',
				'description' => sprintf( esc_html__( 'Enter optional row ID. Make sure it is unique, and it is valid as w3c specification: %s (Must not have spaces)', 'pitchwp' ), '<a target="_blank" href="http://www.w3schools.com/tags/att_global_id.asp">' . esc_html__( 'link', 'pitchwp' ) . '</a>' ),
			),
			array(
				"type" => "colorpicker",
				"class" => "",
		...
		$qode_pitch_IconCollections->getVCParamsArray(array("element" => "hide_icon", "value" => array("no"))),
		array(
			array(
				"type" => "dropdown",
				"class" => "",
...
vc_map( array(
	...
	"params" => array(
		array(
			...
			"holder" => "div",
			"class" => "",
			"heading" => "Scroll Amount (px)",
			"param_name" => "height",
			"description" => "How many pixels of scrolling the animation lasts. The default value adapts to smaller screens."
		),
		array(
			"type" => "attach_image",
			"holder" => "div",
			"class" => "",
			"heading" => "Quicker Top Image",
			"param_name" => "ver_img_1",
			"description" => "This image enters the screen from top moving faster."
		),
		array(
			"type" => "attach_image",
			"holder" => "div",
			"class" => "",
			"heading" => "Quicker Bottom Image",
			"param_name" => "ver_img_2",
			"description" => "This image enters the screen from bottom moving faster."
		),
		array(
			"type" => "attach_image",
			"holder" => "div",
			"class" => "",
			"heading" => "Slower Top Image",
			"param_name" => "ver_img_3",
			"description" => "This image enters the screen from top moving slower."
		),
		array(
			"type" => "attach_image",
			"holder" => "div",
			"class" => "",
			"heading" => "Slower Bottom Image",
			"param_name" => "ver_img_4",
			"description" => "This image enters the screen from bottom moving slower."
		),
		array(
			"type" => "attach_image",
			"holder" => "div",
			"class" => "",
			"heading" => "Image Entering From the Left",
			"param_name" => "hor_img_1",
			"description" => "This image enters the screen from the left."
		),
		array(
			"type" => "attach_image",
			"holder" => "div",
			"class" => "",
			"heading" => "Image Entering From the Right",
			"param_name" => "hor_img_2",
			"description" => "This image enters the screen from the right."
		)
	)
) );
