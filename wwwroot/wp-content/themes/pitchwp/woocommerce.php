...
?>
	...
	?>
		...
		<?php if(isset($qode_pitch_options['woo_products_enable_full_width_template'])&& $qode_pitch_options['woo_products_enable_full_width_template']=="yes" && !is_singular('product')){ ?>
				...
				<?php if(!is_singular('product')) { ?>
					<?php if(($sidebar == "default")||($sidebar == "")) : ?>
						<div class="page-decription_holder">
							<?php qode_pitch_woocommerce_content_before(); ?>
						</div>
						<?php qode_pitch_woocommerce_content(); ?>
					<?php elseif($sidebar == "1" || $sidebar == "2"): ?>		
					<?php global $woocommerce_loop;
			        	$woocommerce_loop['columns'] = 3;
			        ?>
					<?php if(isset($qode_pitch_options['woocommerce_product_list_content_position']) && $qode_pitch_options['woocommerce_product_list_content_position'] == 'content_above_product_list_and_sidebar') { ?>
						<div class="page-decription_holder">
							<?php qode_pitch_woocommerce_content_before(); ?>
						</div>
					<?php }	?>
					...
					<?php endif; ?>
								<div class="column_inner">
									<?php if(isset($qode_pitch_options['woocommerce_product_list_content_position']) && $qode_pitch_options['woocommerce_product_list_content_position'] == 'content_above_product_list') { ?>
											<div class="page-decription_holder">
												<?php qode_pitch_woocommerce_content_before(); ?>
											</div>
									<?php }	?>
					...
					<?php endif; ?>
                <?php } else { 
                      qode_pitch_woocommerce_content();
                } ?>
			</div>
			<?php if($qode_pitch_options['overlapping_content'] == 'yes') {?>
				</div></div>
