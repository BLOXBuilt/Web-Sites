...
} elseif(isset($qode_pitch_options['enable_content_bottom_area'])) {
	//content bottom area is turned on in theme options
	$content_bottom_area = $qode_pitch_options['enable_content_bottom_area'];
}
...
if($content_bottom_area == 'yes') {
	...
	} elseif(isset($qode_pitch_options['content_bottom_sidebar_custom_display'])) {
		//sidebar is chosen for content bottom area in theme options
		$content_bottom_area_sidebar = $qode_pitch_options['content_bottom_sidebar_custom_display'];
	}
	...
	} elseif(isset($qode_pitch_options['content_bottom_in_grid'])) {
		$content_bottom_area_in_grid = $qode_pitch_options['content_bottom_in_grid'];
	}
...
<?php if(($content_bottom_area == "yes") && (is_active_sidebar($content_bottom_area_sidebar))) { ?>
	...
	<div class="content_bottom" <?php qode_pitch_inline_style($content_bottom_background_color); ?>>
