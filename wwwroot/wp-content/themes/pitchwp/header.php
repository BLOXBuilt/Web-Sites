<?php global $qode_pitch_options, $qode_pitch_IconCollections, $wp_query; ?>
<!DOCTYPE html>
<html <?php language_attributes(); ?>>
<head>
    <?php qode_pitch_wp_title(); ?>

    <?php
    /**
     * @see qode_pitch_header_meta() - hooked with 10
     * @see qode_user_scalable - hooked with 10
     */
    ?>
	<?php do_action('qode_pitch_header_meta'); ?>
...
<?php extract(qode_pitch_get_header_variables()); ?>
...
<?php if($loading_animation){ ?>
	<div class="ajax_loader">
        <div class="ajax_loader_1">
            ...
            <?php } else {
				qode_pitch_loading_spinners();
            } ?>
        </div>
    </div>
<?php } ?>
<?php if($enable_side_area == "yes" && $enable_popup_menu == 'no' && qode_pitch_is_top_header()) { ?>
	<section class="side_menu right">
		<?php if(isset($qode_pitch_options['side_area_title']) && $qode_pitch_options['side_area_title'] != "") { ?>
			<div class="side_menu_title">
				<h5><?php echo esc_html($qode_pitch_options['side_area_title']) ?></h5>
			</div>
		<?php } ?>
...
<?php if(qode_pitch_is_side_header()) { ?>
	<aside class="vertical_menu_area<?php echo esc_attr($vertical_area_scroll); ?> <?php echo esc_attr($header_style); ?>">
		<div class="vertical_menu_area_inner">
			<?php if(isset($qode_pitch_options['vertical_area_type']) && ($qode_pitch_options['vertical_area_type'] == 'hidden' || $qode_pitch_options['vertical_area_type'] == 'hidden_with_icons')) { ?>
			...
			<?php if (!(isset($qode_pitch_options['show_logo']) && $qode_pitch_options['show_logo'] == "no")){ ?>
				<div class="vertical_logo_wrapper">
					<?php
					if (isset($qode_pitch_options['logo_image']) && $qode_pitch_options['logo_image'] != ""){ $logo_image = $qode_pitch_options['logo_image'];}else{ $logo_image =  get_template_directory_uri().'/img/logo.png'; };
					if (isset($qode_pitch_options['logo_image_light']) && $qode_pitch_options['logo_image_light'] != ""){ $logo_image_light = $qode_pitch_options['logo_image_light'];}else{ $logo_image_light =  get_template_directory_uri().'/img/logo.png'; };
					if (isset($qode_pitch_options['logo_image_dark']) && $qode_pitch_options['logo_image_dark'] != ""){ $logo_image_dark = $qode_pitch_options['logo_image_dark'];}else{ $logo_image_dark =  get_template_directory_uri().'/img/logo_black.png'; };

					?>
					<div class="q_logo_vertical" style="height: <?php echo esc_attr(intval($qode_pitch_options['logo_height'])/2); ?>px;">
			...
			<nav class="vertical_menu dropdown_animation vertical_menu_<?php echo esc_attr($vertical_menu_style); ?> <?php echo esc_attr($vertical_area_menu_items_arrow); ?>">
				...
				wp_nav_menu( array( 'theme_location' => 'top-navigation' ,
					...
					'link_before' => '<span>',
					'link_after' => '</span>',
					'walker' => new qode_pitch_type1_walker_nav_menu()
				));
				?>
			</nav>
	...
	<?php if((isset($qode_pitch_options['vertical_area_type']) && ($qode_pitch_options['vertical_area_type'] == 'hidden' || $qode_pitch_options['vertical_area_type'] == 'hidden_with_icons')) &&
		(isset($qode_pitch_options['vertical_logo_bottom']) && $qode_pitch_options['vertical_logo_bottom'] !== '')) { ?>
		<div class="vertical_menu_area_bottom_logo">
			<div class="vertical_menu_area_bottom_logo_inner">
				<a href="javascript: void(0)">
					<img src="<?php echo esc_url($qode_pitch_options['vertical_logo_bottom']); ?>" alt="vertical_menu_area_bottom_logo"/>
				</a>
			</div>
		</div>
	<?php } ?>
...
<?php if(qode_pitch_space_around_content()){

    $frame_around_content_class = '';
    if($qode_pitch_options['frame_around_content'] == 'yes'){
...
<?php if(qode_pitch_is_top_header()){ ?>
	...
	<?php if($header_bottom_appearance == "regular" || $header_bottom_appearance == "fixed" || $header_bottom_appearance == "fixed_hiding" || $header_bottom_appearance == "stick" || $header_bottom_appearance == "stick menu_bottom" || $header_bottom_appearance == "stick_with_left_right_menu"){ ?>
		<header class="<?php qode_pitch_header_classes(); ?>">
			<div class="header_inner clearfix">
				<?php if(isset($qode_pitch_options['enable_search']) && $qode_pitch_options['enable_search'] == "yes" ){ ?>
					<?php if( ($header_color_transparency_per_page == '' || $header_color_transparency_per_page == '1') && ($header_color_transparency_on_scroll=='' || $header_color_transparency_on_scroll == '1') &&  isset($qode_pitch_options['search_type']) && $qode_pitch_options['search_type'] == "search_slides_from_header_bottom"){ ?>
							 ...
							 <?php } ?>
								<div class="form_holder_outer">
									<div class="form_holder">
										<input type="text" placeholder="<?php esc_html_e('Search', 'pitchwp'); ?>" name="s" class="qode_search_field" autocomplete="off" />
                                        <a class="qode_search_submit" href="javascript:void(0)">
                                            <?php $qode_pitch_IconCollections->getSearchIcon($qode_pitch_options['search_icon_pack']); ?>
                                        </a>
									</div>
								</div>
								<?php if($header_in_grid){ ?>
				...
				<?php } else if(isset($qode_pitch_options['search_type']) && $qode_pitch_options['search_type'] == "search_covers_header") { ?>
										...
										<div class="form_holder">
											<div class="form_holder_inner">
												...
												<div class="qode_search_close">
													<a href="#">
														<?php if(isset($qode_pitch_options['header_icon_pack'])) { $qode_pitch_IconCollections->getSearchClose($qode_pitch_options['header_icon_pack']); } ?>
				...
				<?php } else if(isset($qode_pitch_options['search_type']) && $qode_pitch_options['search_type'] == "search_slides_from_window_top") { ?>
			...
			<div class="header_top_bottom_holder">
				...
				<?php if($display_header_top == "yes"){ ?>
					<div class="header_top clearfix	<?php if(isset($qode_pitch_options['header_top_has_background_pattern']) && $qode_pitch_options['header_top_has_background_pattern'] == "yes") {echo "has_pattern";}?>"	<?php qode_pitch_inline_style($header_top_color_per_page); ?> >
						<?php if($header_in_grid){ ?>
						<div class="container">
							<div class="container_inner clearfix" >
							...
							<?php if($qode_pitch_options['overlapping_content'] == 'yes') {?><div class="overlapping_content_margin"><?php } ?>
								...
								<div class="right">
									<div class="inner">
        								...
        								<?php if(isset($qode_pitch_options['enable_search']) && $qode_pitch_options['enable_search'] == 'yes'  && isset($qode_pitch_options['search_icon_in_header_top']) && $qode_pitch_options['search_icon_in_header_top'] == 'yes'){ ?>
											<div class="header_top_side_button">
												<a class="<?php echo esc_attr($header_search_type); ?> <?php echo esc_attr($header_button_size); ?>" href="javascript:void(0)">
													<?php if(isset($qode_pitch_options['search_icon_pack'])){
														$qode_pitch_IconCollections->getSearchIcon($qode_pitch_options['search_icon_pack']);
													} ?>
													<?php if(isset($qode_pitch_options['enable_search_icon_text']) && $qode_pitch_options['enable_search_icon_text'] == 'yes'){?>
														<span class="search_icon_text">
															<?php esc_html_e('Search', 'pitchwp'); ?>
														</span>
													<?php } ?>
												</a>
				...
				<?php } ?>
				<div class="header_bottom <?php echo esc_attr($header_bottom_class) ;?> clearfix <?php if($menu_item_icon_position=="top"){echo 'with_large_icons ';} if($menu_position == "left" && $header_bottom_appearance != "fixed_hiding" && $header_bottom_appearance != "stick menu_bottom" && $header_bottom_appearance != "stick_with_left_right_menu"){ echo 'left_menu_position';} ?>" <?php qode_pitch_inline_style($header_color_per_page); ?> >
					
					<?php if($header_in_grid){ ?>
					<div class="container">
						<div class="container_inner clearfix" <?php qode_pitch_inline_style($header_bottom_border_style); ?>>
						<?php if($qode_pitch_options['overlapping_content'] == 'yes') {?><div class="overlapping_content_margin"><?php } ?>
							<?php } ?>
							<?php if($header_bottom_appearance == "stick_with_left_right_menu") { ?>
								<nav class="main_menu drop_down left_side <?php echo esc_attr($menu_hover_animation_class); ?> <?php echo esc_attr($menu_dropdown_appearance_class); ?>" <?php qode_pitch_inline_style($divided_left_menu_padding); ?>>
							...
							<div class="header_inner_left">
								...
								<?php if(qode_pitch_is_main_menu_set()) { ?>
									<div class="mobile_menu_button">
										<span>
											<?php $qode_pitch_IconCollections->getMobileMenuIcon($qode_pitch_options['header_icon_pack']); ?>
										</span>
									</div>
								<?php } ?>
								...
								<?php if (!(isset($qode_pitch_options['show_logo']) && $qode_pitch_options['show_logo'] == "no")){ ?>
									<div class="logo_wrapper" <?php qode_pitch_inline_style($logo_wrapper_style); ?>>
										<?php
										if (isset($qode_pitch_options['logo_image']) && $qode_pitch_options['logo_image'] != ""){ $logo_image = $qode_pitch_options['logo_image'];}else{ $logo_image =  get_template_directory_uri().'/img/logo.png'; };
										if (isset($qode_pitch_options['logo_image_light']) && $qode_pitch_options['logo_image_light'] != ""){ $logo_image_light = $qode_pitch_options['logo_image_light'];}else{ $logo_image_light =  get_template_directory_uri().'/img/logo.png'; };
										if (isset($qode_pitch_options['logo_image_dark']) && $qode_pitch_options['logo_image_dark'] != ""){ $logo_image_dark = $qode_pitch_options['logo_image_dark'];}else{ $logo_image_dark =  get_template_directory_uri().'/img/logo_black.png'; };
										if (isset($qode_pitch_options['logo_image_sticky']) && $qode_pitch_options['logo_image_sticky'] != ""){ $logo_image_sticky = $qode_pitch_options['logo_image_sticky'];}else{ $logo_image_sticky =  get_template_directory_uri().'/img/logo_black.png'; };
										if (isset($qode_pitch_options['logo_image_popup']) && $qode_pitch_options['logo_image_popup'] != ""){ $logo_image_popup = $qode_pitch_options['logo_image_popup'];}else{ $logo_image_popup =  get_template_directory_uri().'/img/logo_white.png'; };
										if (isset($qode_pitch_options['logo_image_fixed_hidden']) && $qode_pitch_options['logo_image_fixed_hidden'] != ""){ $logo_image_fixed_hidden = $qode_pitch_options['logo_image_fixed_hidden'];}else{ $logo_image_fixed_hidden =  get_template_directory_uri().'/img/logo.png'; };
										if (isset($qode_pitch_options['logo_image_mobile']) && $qode_pitch_options['logo_image_mobile'] != ""){
											$logo_image_mobile = $qode_pitch_options['logo_image_mobile'];
										}else{ 
											if(isset($qode_pitch_options['logo_image']) && $qode_pitch_options['logo_image'] != ""){
												$logo_image_mobile = $qode_pitch_options['logo_image'];
											}else{ 
												$logo_image_mobile =  get_template_directory_uri().'/img/logo.png'; 
											}
										}
										?>
										<div class="q_logo"><a <?php qode_pitch_inline_style($logo_wrapper_style); ?> href="<?php echo esc_url(home_url('/')); ?>"><img class="normal" src="<?php echo esc_url($logo_image); ?>" alt="Logo"/><img class="light" src="<?php echo esc_url($logo_image_light); ?>" alt="Logo"/><img class="dark" src="<?php echo esc_url($logo_image_dark); ?>" alt="Logo"/><img class="sticky" src="<?php echo esc_url($logo_image_sticky); ?>" alt="Logo"/><img class="mobile" src="<?php echo esc_url($logo_image_mobile); ?>" alt="Logo"/><?php if($enable_popup_menu == 'yes'){ ?><img class="popup" src="<?php echo esc_url($logo_image_popup); ?>" alt="Logo"/><?php } ?></a></div>
							...
							<?php if($header_bottom_appearance == "stick_with_left_right_menu") { ?>
								<nav class="main_menu drop_down right_side <?php echo esc_attr($menu_hover_animation_class); ?> <?php echo esc_attr($menu_dropdown_appearance_class); ?>" <?php qode_pitch_inline_style($divided_right_menu_padding); ?>>
									<?php
									...
									<div class="side_menu_button_wrapper right">
										...
										<?php if(isset($qode_pitch_options['enable_search']) && $qode_pitch_options['enable_search'] == 'yes' && (!isset($qode_pitch_options['search_icon_in_header_top']) || $qode_pitch_options['search_icon_in_header_top'] == 'no')) { ?>
											<a class="<?php echo esc_attr($header_search_type); ?> <?php echo esc_attr($header_button_size); ?>" href="javascript:void(0)">
												<?php if(isset($qode_pitch_options['search_icon_pack'])){
                                                    $qode_pitch_IconCollections->getSearchIcon($qode_pitch_options['search_icon_pack']);
												} ?>
										...
										<?php if($enable_side_area == "yes" && $enable_popup_menu == 'no' && $top_menu_appearance == "off"){ ?>
											...
											<?php echo qode_pitch_get_side_menu_icon_html(); ?></a>
										<?php } ?>
										</div>
									</div>
								</nav>
							...
							<?php if($header_bottom_appearance != "stick menu_bottom" && $header_bottom_appearance != "stick_with_left_right_menu"){ ?>
								...
								<nav class="main_menu drop_down <?php echo esc_attr($menu_hover_animation_class); ?> <?php  echo esc_attr($menu_dropdown_appearance_class); if($menu_position == "" && $header_bottom_appearance != "stick menu_bottom"){ echo ' right';} ?>">
									...
									?>
								<?php if(isset($qode_pitch_options['menu_item_hover_animation']) && $qode_pitch_options['menu_item_hover_animation'] == "underline_follow" ){ ?>
								...
								<?php if($centered_logo) { ?>
									<div class="header_inner_right">
										<div class="side_menu_button_wrapper right">
											...
											<?php } ?>
											<div class="side_menu_button"> 
												<?php if($enable_search_left_sidearea_right == false && (isset($qode_pitch_options['enable_search']) && $qode_pitch_options['enable_search'] == 'yes')  && (!isset($qode_pitch_options['search_icon_in_header_top']) || $qode_pitch_options['search_icon_in_header_top'] == 'no')) { ?>
													<a class="<?php echo esc_attr($header_search_type); ?> <?php echo esc_attr($header_button_size); ?>" href="javascript:void(0)">
														<?php if(isset($qode_pitch_options['search_icon_pack'])){
															$qode_pitch_IconCollections->getSearchIcon($qode_pitch_options['search_icon_pack']);
														} ?>
												...
												<?php if($enable_side_area == "yes" && $enable_popup_menu == 'no' && $top_menu_appearance == "off"){ ?>
													<a class="side_menu_button_link <?php echo esc_attr($header_button_size); ?>" href="javascript:void(0)">
														<?php echo qode_pitch_get_side_menu_icon_html(); ?>
													</a>
												<?php } ?>
								...
								<nav class="mobile_menu">
									...
									if($header_bottom_appearance == "stick_with_left_right_menu") {
										...
										wp_nav_menu( array( 'theme_location' => 'left-top-navigation' ,
											...
											'link_before' => '<span>',
											'link_after' => '</span>',
											'walker' => new qode_pitch_type4_walker_nav_menu(),
											'items_wrap'      => '%3$s'
										));
										wp_nav_menu( array( 'theme_location' => 'right-top-navigation' ,
											'container'  => '',
										...
										wp_nav_menu( array( 'theme_location' => 'top-navigation' ,
											...
											'link_before' => '<span>',
											'link_after' => '</span>',
											'walker' => new qode_pitch_type2_walker_nav_menu()
										));
									}
									?>
								</nav>
...
<?php //FIXED HEADER TOP Header Type ?>
	...
	<header class="<?php qode_pitch_header_classes(); ?>">
		<div class="header_inner clearfix">
			<!--insert start-->
				<?php if(isset($qode_pitch_options['enable_search']) && $qode_pitch_options['enable_search'] == "yes" ){ ?>
					<?php  if(isset($qode_pitch_options['search_type']) && $qode_pitch_options['search_type'] == "search_covers_header") { ?>
						<form role="search" action="<?php echo esc_url(home_url('/')); ?>" class="qode_search_form_3" method="get">
								<?php if($header_in_grid){ ?>
								<div class="container">
									<div class="container_inner clearfix">
			...
			<div class="header_top_bottom_holder">
				<?php if($display_header_top == "yes"){ ?>
					<div class="top_header clearfix" <?php qode_pitch_inline_style($header_top_color_per_page); ?> >
						<?php if($header_in_grid){ ?>
						<div class="container">
							<div class="container_inner clearfix" >
							<?php if($qode_pitch_options['overlapping_content'] == 'yes') {?><div class="overlapping_content_margin"><?php } ?>
											...
											<div class="side_menu_button">
												<?php if(isset($qode_pitch_options['enable_search']) && $qode_pitch_options['enable_search'] == 'yes') { ?>
													<a class="search_covers_header <?php echo esc_attr($header_button_size); ?>" href="javascript:void(0)">
														<?php if(isset($qode_pitch_options['search_icon_pack'])){ $qode_pitch_IconCollections->getSearchIcon($qode_pitch_options['search_icon_pack']); } ?>
													</a>
												<?php } ?>
				...
				<?php } ?>
				<div class="bottom_header clearfix" <?php qode_pitch_inline_style($header_color_per_page); ?> >
					<?php if($header_in_grid){ ?>
					<div class="container">
						<div class="container_inner clearfix" <?php qode_pitch_inline_style($header_bottom_border_style); ?>>
						<?php if($qode_pitch_options['overlapping_content'] == 'yes') {?><div class="overlapping_content_margin"><?php } ?>
		...
		<header class="<?php qode_pitch_header_classes(); ?>">
			<div class="header_inner clearfix">
				...
				<div class="header_top_bottom_holder">
					...
					<?php } ?>
					<div class="header_bottom <?php echo esc_attr($header_bottom_class) ;?> clearfix" <?php qode_pitch_inline_style($header_color_per_page); ?> >
						<?php if($header_in_grid){ ?>
						<div class="container">
							<div class="container_inner clearfix" <?php qode_pitch_inline_style($header_bottom_border_style); ?>>
							<?php if($qode_pitch_options['overlapping_content'] == 'yes') {?><div class="overlapping_content_margin"><?php } ?>
...
<header class="<?php qode_pitch_header_classes(); ?>">
					...
					<?php if($qode_pitch_options['overlapping_content'] == 'yes') {?><div class="overlapping_content_margin"><?php } ?>
					 <?php } ?>
						<div class="form_holder_outer">
							<div class="form_holder">
								<input type="text" placeholder="<?php esc_html_e('Search', 'pitchwp'); ?>" name="s" class="qode_search_field" autocomplete="off" />
								<!--<input type="submit" class="qode_search_submit" value="<?php /*if (isset($qode_pitch_options['header_icon_pack'])) { $qode_pitch_IconCollections->getSearchIconValue($qode_pitch_options['header_icon_pack']); } */?>"/>-->
	...
	<?php } ?>
		...
		<?php } ?>
            ...
            ($menu_item_icon_position=="top"){echo 'with_large_icons ';}?>" <?php qode_pitch_inline_style($header_color_per_page); ?> >
			<?php if($header_in_grid){ ?>
				<div class="container">
					<div class="container_inner clearfix" <?php qode_pitch_inline_style($header_bottom_border_style); ?>>
					<?php if($qode_pitch_options['overlapping_content'] == 'yes') {?><div class="overlapping_content_margin"><?php } ?>
...
<?php if($qode_pitch_options['show_back_button'] == "yes") {
    $q_back_to_top_button_styles = "";
    if(isset($qode_pitch_options['back_to_top_position']) && !empty($qode_pitch_options['back_to_top_position'])) {
        $q_back_to_top_button_styles = $qode_pitch_options['back_to_top_position'];
    } ?>
	<?php if(!(isset($qode_pitch_options['back_to_top_button_type']) && ($qode_pitch_options['back_to_top_button_type']) =='triangle')) { ?>
		<a id='back_to_top' class="<?php echo esc_attr($q_back_to_top_button_styles);?>" href='#'>
			<span class="qode_icon_stack">
				<?php if(isset($qode_pitch_options['show_back_button_icon']) && $qode_pitch_options['show_back_button_icon']!== '') { ?>
				<span <?php qode_pitch_class_attribute($qode_pitch_options['show_back_button_icon'])?>></span>
				<?php } else {
					$qode_pitch_IconCollections->getBackToTopIcon('font_awesome');
				} ?>
			</span>
		</a>
	<?php } ?>
...
<?php if($enable_popup_menu == "yes"){
	...
	<div class="popup_menu_holder_outer">
		<div class="popup_menu_holder">
			...
			<?php if (isset($qode_pitch_options['popup_in_grid']) && $qode_pitch_options['popup_in_grid'] == "yes") { ?>
			...
			<?php } ?>
				...
				<nav class="popup_menu">
					...
					wp_nav_menu( array( 'theme_location' => 'popup-navigation' ,
						...
						'link_before' => '<span>',
						'link_after' => '</span>',
						'walker' => new qode_pitch_type3_walker_nav_menu()
					));
					?>
				</nav>
			...
			<div class="fullscreen_search_cell">
				<div class="fullscreen_search_inner">
					<form role="search" action="<?php echo esc_url(home_url('/')); ?>" class="fullscreen_search_form" method="get">
						<div class="form_holder">
							<span class="search_label"><?php esc_html_e('Search:', 'pitchwp'); ?></span>
...
if((get_post_meta($id, "qode_revolution-slider", true) == "" && ($header_transparency == '' || $header_transparency == 1))  || get_post_meta($id, "qode_enable_content_top_margin", true) == "yes" ){
	if($qode_pitch_options['header_bottom_appearance'] == "fixed" || $qode_pitch_options['header_bottom_appearance'] == "fixed_hiding" || $qode_pitch_options['header_bottom_appearance'] == "fixed fixed_minimal"){
...
if(qode_pitch_get_page_template_name() == "full_screen"){
    // solution for top header
    if(!qode_pitch_is_side_header()){
        if (($header_transparency == '' || $header_transparency == 1) || ($qode_pitch_options['header_bottom_appearance'] == "regular" || $qode_pitch_options['header_bottom_appearance'] == "fixed_top_header")) {
            if ($qode_pitch_options['header_bottom_appearance'] == "fixed" || $qode_pitch_options['header_bottom_appearance'] == "fixed_hiding" || $qode_pitch_options['header_bottom_appearance'] == "fixed fixed_minimal") {
                $content_class = "content_top_margin_none";
            }
            elseif($qode_pitch_options['header_bottom_appearance'] == 'stick menu_bottom'){
    ...
    if((isset($qode_pitch_options['paspartu']) && $qode_pitch_options['paspartu'] == 'yes') && (isset($qode_pitch_options['paspartu_on_top']) && $qode_pitch_options['paspartu_on_top'] == 'yes')){
        if(isset($qode_pitch_options['paspartu_on_top_fixed']) && $qode_pitch_options['paspartu_on_top_fixed'] == 'yes'){
            if(!(qode_pitch_is_side_header() && (isset($qode_pitch_options['vertical_menu_inside_paspartu']) && $qode_pitch_options['vertical_menu_inside_paspartu'] == 'yes'))){ // not for this case
...
if(isset($qode_pitch_options['paspartu_on_top']) && $qode_pitch_options['paspartu_on_top'] == 'no'){
    $paspartu_additional_classes .= " disable_top_paspartu";
}
if(isset($qode_pitch_options['paspartu_on_bottom']) && $qode_pitch_options['paspartu_on_bottom'] == 'no'){
    $paspartu_additional_classes .= " disable_bottom_paspartu";
}
if(isset($qode_pitch_options['paspartu_on_bottom_slider']) && $qode_pitch_options['paspartu_on_bottom_slider'] == 'yes'){
    $paspartu_additional_classes .= " paspartu_on_bottom_slider";
}
if((isset($qode_pitch_options['paspartu_on_bottom']) && $qode_pitch_options['paspartu_on_bottom'] == 'yes' && isset($qode_pitch_options['paspartu_on_bottom_fixed']) && $qode_pitch_options['paspartu_on_bottom_fixed'] == 'yes') ||
...
<div class="paspartu_outer <?php echo esc_attr($paspartu_additional_classes); ?>">
	...
	<?php if((isset($qode_pitch_options['paspartu_on_top']) && $qode_pitch_options['paspartu_on_top'] == 'yes' && isset($qode_pitch_options['paspartu_on_top_fixed']) && $qode_pitch_options['paspartu_on_top_fixed'] == 'yes') ||
	(qode_pitch_is_side_header() && isset($qode_pitch_options['vertical_menu_inside_paspartu']) && $qode_pitch_options['vertical_menu_inside_paspartu'] == 'yes')){ ?>
...
<div class="content <?php echo esc_attr($content_class); ?>">
	...
	?>
	<?php if($qode_pitch_options['page_transitions'] == "1" || $qode_pitch_options['page_transitions'] == "2" || $qode_pitch_options['page_transitions'] == "3" || $qode_pitch_options['page_transitions'] == "4" || ($animation == "updown") || ($animation == "fade") || ($animation == "updown_fade") || ($animation == "leftright")){ ?>
		<div class="meta">
			<?php do_action('qode_pitch_ajax_meta'); ?>
	...
	<div class="content_inner <?php echo esc_attr($animation);?> ">
		<?php if($qode_pitch_options['page_transitions'] == "1" || $qode_pitch_options['page_transitions'] == "2" || $qode_pitch_options['page_transitions'] == "3" || $qode_pitch_options['page_transitions'] == "4" || ($animation == "updown") || ($animation == "fade") || ($animation == "updown_fade") || ($animation == "leftright")){ ?>
		<?php do_action('qode_pitch_visual_composer_custom_shortcode_css');?>
	<?php } ?>