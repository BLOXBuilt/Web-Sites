...
class Qode_Pitch_Latest_Posts extends WP_Widget {
	private $params;
	public function __construct() {
		parent::__construct(
			'qode_latest_posts_widget', // Base ID
			'Select Blog', // Name
			array( 'description' => esc_html__( 'Display posts from your blog', 'pitchwp' ), ) // Args
		);
	...
	protected function setParams() {
		$this->params = array(
			...
			array(
				...
				'title' => 'Date Position',
				'options' => array(
					'by_title' => 'Date by Title',
					'by_post_info' => 'Date by Post Info'
				)
			),
			array(
				'name' => 'date_size',
...
function qode_pitch_latest_posts_widget_load(){
	register_widget('Qode_Pitch_Latest_Posts');
}

add_action('widgets_init', 'qode_pitch_latest_posts_widget_load');
