...
class Qode_Pitch_Instagram_Widget extends WP_Widget {
    private $params;
    public function __construct() {
        parent::__construct(
            'qode_instagram_widget',
            'Select Instagram Widget',
            array( 'description' => esc_html__( 'Display instagram images', 'pitchwp' ) )
        );
    ...
    public function widget($args, $instance) {
        ...
        $instagram_api = QodePitchInstagramApi::getInstance();
            ...
            foreach ($images_array as $image) { ?>
                <li>
                    <a href="<?php echo esc_url($instagram_api->getHelper()->getImageLink($image)); ?>" target="_blank">
                        <?php echo qode_pitch_kses_img($instagram_api->getHelper()->getImageHTML($image, $image_size)); ?>
                    </a>
                </li>
            <?php } ?>
            </ul>
...
function qode_pitch_instagram_widget_load(){
    register_widget('Qode_Pitch_Instagram_Widget');
}

add_action('widgets_init', 'qode_pitch_instagram_widget_load');