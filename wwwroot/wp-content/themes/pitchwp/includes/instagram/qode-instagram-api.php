...
include get_template_directory().'/includes/instagram/qode-instagram-helper.php';

/**
 * Class QodePitchInstagramApi
 */
class QodePitchInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var QodePitchInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var QodePitchInstagramHelper
     */
    private $helper;
    ...
    private function __construct() {
        ...
        $this->helper = new QodePitchInstagramHelper();
    }
     ...
     * @return string
     *
     * @see QodePitchInstagramApi::buildCurrentPageURI()
     */
    ...
    /**
     * @return QodePitchInstagramHelper
     */
     ...
     *
     * @see QodePitchInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see QodePitchInstagramApi::getAccessToken()
     */
    ...
    public function disconnectUser() {
       if($this->hasUserConnected()) {
           ...
           if ($response) {
               ...
               $responseObj->message = __('Couldn\'t disconnect from Instagram', 'pitchwp');
           }
