...
if( ! class_exists( 'Qode_Pitch_Sidebar' ) ){
	
	class Qode_Pitch_Sidebar{
		...
		function __construct(){
			...
			$this->title = esc_html__('Custom Widget Area','pitchwp');
		...
		function load_assets(){
			...
			wp_enqueue_script('qode_pitch_sidebar' , QODE_ROOT . '/framework/admin/assets/js/qodef-sidebar.js');
			wp_enqueue_style( 'qode_pitch_sidebar' , QODE_ROOT . '/framework/admin/assets/css/qodef-sidebar.css');
		}
		...
		function template_add_widget_field(){
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".esc_html__('Enter Name of the new Widget Area', 'pitchwp')."' name='qode-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='".esc_html__('Add Widget Area', 'pitchwp')."' />";
			echo "\n    ".$nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
