...
if(!function_exists('qode_pitch_register_sidebars')) {
    /**
     * Function that registers theme's sidebars
     */
    function qode_pitch_register_sidebars() {
        global $qode_pitch_options;
        $centered_logo = false;

        if (isset($qode_pitch_options['center_logo_image'])){ if($qode_pitch_options['center_logo_image'] == "yes") { $centered_logo = true; }};
		...
		if((isset($qode_pitch_options['header_bottom_appearance']) && $qode_pitch_options['header_bottom_appearance'] == "stick_with_left_right_menu") ||  $centered_logo == true){
			register_sidebar(array(
    ...
    add_action('widgets_init', 'qode_pitch_register_sidebars');
}

if(!function_exists('qode_pitch_add_support_custom_sidebar')) {
    /**
     * Function that adds theme support for custom sidebars. It also creates Qode_Pitch_Sidebar object
     */
    function qode_pitch_add_support_custom_sidebar() {
        add_theme_support('qode_sidebar');
        if (get_theme_support('qode_sidebar')) new Qode_Pitch_Sidebar();
    }

    add_action('after_setup_theme', 'qode_pitch_add_support_custom_sidebar');
}
