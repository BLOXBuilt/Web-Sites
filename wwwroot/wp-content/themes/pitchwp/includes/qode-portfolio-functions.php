...
if(!function_exists('qode_pitch_get_portfolio_image_meta')) {
	function qode_pitch_get_portfolio_image_meta($image_src) {
		global $wpdb;
...
if (!function_exists('qode_pitch_comparePortfolioImages')) {
	/**
	 ...
	 */
	function qode_pitch_comparePortfolioImages($a, $b){
...
if (!function_exists('qode_pitch_comparePortfolioOptions')){
	/**
	 ...
	 * @return int result of comparison
	 */
	function qode_pitch_comparePortfolioOptions($a, $b){
