...
class Qode_Twitter_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            array( 'description' =>  esc_html__( 'Display tweets', 'pitchwp' ) )
        );
    ...
    public function widget($args, $instance) {
        ...
        $twitter_api = QodePitchTwitterApi::getInstance();
        ...
        if($twitter_api->hasUserConnected()) {
            ...
            esc_html_e('It seams that you haven\'t connected with your Twitter account','pitchwp');
        }
