...
function qode_slides_category_taxonomy_custom_fields($tag) {
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Effect on header (dark/light style)', 'qode_core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Show prev/next thumbs (except for side menu or passepartout)', 'qode_core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Show slide number', 'qode_core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Parallax effect', 'qode_core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 1 (values: 0-1, default value: 1)', 'qode_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'qode_core'); ?></label>
            ...
            <div class="inline">
                <label for="shortcode"><?php _e('Title', 'qode_core'); ?></label>
            ...
            <div class="inline">
                <label for="shortcode"><?php _e('Subtitle', 'qode_core'); ?></label>
            ...
            <div class="inline">
                <label for="shortcode"><?php _e('Text', 'qode_core'); ?></label>
            ...
            <div class="inline">
                <label for="shortcode"><?php _e('Button', 'qode_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width > 1600px for 'set1' and 'set2'", 'qode_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 2 (values: 0-1, default value: 1)', 'qode_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'qode_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width = [1200px,1600px] for 'set1', screen width = [1300px,1600px] for 'set2'", 'qode_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 3 (values: 0-1, default value: 0.8)', 'qode_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'qode_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width = [900px,1200px] for 'set1', screen width = [1000px,1300px] for 'set2'", 'qode_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 4 (values: 0-1, default value: 0.7)', 'qode_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'qode_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width = [650px,900px] for 'set1', screen width = [768px,1000px] for 'set2'", 'qode_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 5 (values: 0-1, default value: 0.6)', 'qode_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'qode_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width = [500px,650px] for 'set1', screen width = [567px,768px] for 'set2'", 'qode_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 6 (values: 0-1, default value: 0.5)', 'qode_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'qode_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width = [320px,500px] for 'set1', screen width = [320px,567px] for 'set2'", 'qode_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 7 (values: 0-1, default value: 0.4)', 'qode_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'qode_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width < 320px for 'set1' and 'set2'", 'qode_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Slider shortcode', 'qode_core'); ?></label>
        </th>
        <td>
            ...
            <span class="description"><?php _e('Use this shortcode to insert it on page', 'qode_core'); ?></span>
        </td>
    </tr>
...
function qode_theme_columns($theme_columns) {
    $new_columns = array(
        ...
        'name' => esc_html__('Name', 'qode_core'),
        'shortcode' => esc_html__('Shortcode', 'qode_core'),
        //'description' => esc_html__('Description', 'qode_core'),
        'slug' => esc_html__('Slug', 'qode_core'),
        'posts' => esc_html__('Posts', 'qode_core')
    );
    return $new_columns;
}
