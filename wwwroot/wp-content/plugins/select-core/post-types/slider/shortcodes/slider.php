...
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
            ...
            if ($slider_parallax == 'no' || (isset($qode_pitch_options['paspartu']) && $qode_pitch_options['paspartu'] == 'yes' && (isset($qode_pitch_options['paspartu_on_top']) && $qode_pitch_options['paspartu_on_top'] == 'yes' && $qode_pitch_options['paspartu_on_top_fixed'] == 'no'))) {
            ...
            if (isset($slider_meta['slider_thumbs'])) {
                ...
                if(isset($qode_pitch_options['vertical_area']) && $qode_pitch_options['vertical_area'] =='yes' && isset($qode_pitch_options['paspartu']) && $qode_pitch_options['paspartu'] == 'yes') {
                    $slider_thumbs = 'no';
                }
            }
            ...
            if (isset($qode_pitch_options['header_background_transparency_initial']) && $qode_pitch_options['header_background_transparency_initial'] != "1" && $qode_pitch_options['header_background_transparency_initial'] != "") {
            ...
            if (isset($qode_pitch_options['navigation_button_height']) && $qode_pitch_options['navigation_button_height'] != '') {
                $arrow_button_height = esc_attr($qode_pitch_options['navigation_button_height']);
            }
            ...
            if (isset($qode_pitch_options['enable_manu_item_border']) && $qode_pitch_options['enable_manu_item_border'] == 'yes' && isset($qode_pitch_options['menu_item_style']) && $qode_pitch_options['menu_item_style'] == 'large_item') {
                if (isset($qode_pitch_options['menu_item_border_style']) && $qode_pitch_options['menu_item_border_style'] == 'all_borders') {
                    $large_menu_item_border = esc_attr($qode_pitch_options['menu_item_border_width']) * 2;
                }
                if (isset($qode_pitch_options['menu_item_border_style']) && $qode_pitch_options['menu_item_border_style'] == 'top_bottom_borders') {
                    $large_menu_item_border = esc_attr($qode_pitch_options['menu_item_border_width']) * 2;
                }
                if (isset($qode_pitch_options['menu_item_border_style']) && $qode_pitch_options['menu_item_border_style'] == 'bottom_border') {
                    $large_menu_item_border = esc_attr($qode_pitch_options['menu_item_border_width']);
                }
            }
            ...
            if (isset($qode_pitch_options['header_bottom_appearance'])) {
                switch ($qode_pitch_options['header_bottom_appearance']) {
                    case 'stick':
                        $logo_height = esc_attr($qode_pitch_options['logo_height']) / 2;
                        break;
                    ...
                    case 'fixed_hiding':
                        ...
                        break;
                    case 'regular':
                    	if (isset($qode_pitch_options['center_logo_image']) && $qode_pitch_options['center_logo_image'] == "yes"){
                        	$logo_height = esc_attr($qode_pitch_options['logo_height']) / 2;
                    	}
                    	else {
                        	$logo_height = esc_attr($qode_pitch_options['logo_height']);
                    	}
                    	break;
                    default:
                        $logo_height = esc_attr($qode_pitch_options['logo_height']);
            ...
            if ((get_post_meta($page_id, "qode_header_color_transparency_per_page", true) !== "0") && ($qode_pitch_options['header_background_transparency_initial'] !== "0") && ((isset($qode_pitch_options['paspartu']) && $qode_pitch_options['paspartu'] == 'no') || (isset($qode_pitch_options['paspartu_on_top']) && $qode_pitch_options['paspartu_on_top'] == 'no')) && !$hide_sticky_header) {

                $header_height_padding = $header_height + $menu_bottom + $header_top;
                if ((isset($qode_pitch_options['center_logo_image']) && $qode_pitch_options['center_logo_image'] == "yes" && $qode_pitch_options['header_bottom_appearance'] !== 'stick menu_bottom' && $qode_pitch_options['header_bottom_appearance'] !== 'stick_with_left_right_menu') || $qode_pitch_options['header_bottom_appearance'] == "fixed_hiding") {
            ...
            $custom_cursor = "";
            if(isset($qode_pitch_options['qs_enable_navigation_custom_cursor']) && ($qode_pitch_options['qs_enable_navigation_custom_cursor']=="yes")){
                $custom_cursor = "has_custom_cursor";
            }

            if((isset($qode_pitch_options['paspartu']) && $qode_pitch_options['paspartu'] == 'yes' && (isset($qode_pitch_options['paspartu_on_top']) && $qode_pitch_options['paspartu_on_top'] == 'yes' && $qode_pitch_options['paspartu_on_top_fixed'] == 'no')) || $slider_parallax == "no"){
            ...
            if($qode_pitch_options['loading_animation'] == "on") {
                if($qode_pitch_options['loading_image'] != "") {
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1"><div class="ajax_loader_2"><img src="' . esc_url($qode_pitch_options['loading_image']) . '" alt="" /></div></div></div>';
                }else{
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1">' . qode_pitch_loading_spinners(true) . '</div></div>';
                }
            }

            $html .= '<div id="qode-' . esc_attr($slider) . '" ' . $anchor_data . ' ' . $responsiveness_data . ' ' . $responsive_coefficients_graphic_data . ' ' . $responsive_coefficients_title_data . ' ' . $responsive_coefficients_subtitle_data . ' ' . $responsive_coefficients_text_data . ' ' . $responsive_coefficients_button_data . ' class="carousel slide ' . esc_attr($animation_type_class . ' ' . $custom_cursor . ' ' . $full_screen_class . ' ' . $responsive_height_class . ' ' . $height_class . ' ' . $auto_start_class . ' ' . $header_effect_class . ' ' . $slider_numbers_class .  ' ' . $slider_thumbs_class . ' ' . $slider_transparency_class . ' ' . $navigation_position_class . ' ' . $content_next_to_arrows_class) . '" ' . $slide_animation . ' ' . $data_height . ' ' . $data_parallax_effect . ' '.qode_pitch_get_inline_style($slide_holder_height. $background_color).'><div class="qode_slider_preloader" '.qode_pitch_get_inline_style($background_color).'>'.$ajax_loader.'</div>';
            $html .= '<div class="carousel-inner ' . esc_attr($slider_css_position_class) . '" '.qode_pitch_get_inline_style($carouselinner_height).' '.$data_parallax_transform.'>';
            query_posts($args);
            ...
            if (have_posts()) : $postCount = 0;
                while (have_posts()) : the_post();
                    ...
                    $thumbnail_attributes = qode_pitch_get_attachment_meta_from_url($thumbnail, array('width','height'));
					...
					if (get_post_meta(get_the_ID(), "qode_slide_text_content_top_margin", true) != "") {
                        $slide_content_style .= "margin-top: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide_text_content_top_margin", true)) . "px;";
                    }
					if (get_post_meta(get_the_ID(), "qode_slide_text_content_bottom_margin", true) != "") {
                        $slide_content_style .= "margin-bottom: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide_text_content_bottom_margin", true)) . "px;";
                    }
					
					if (get_post_meta(get_the_ID(), "qode_slide_text_content_box_shaddow", true) != "") {
                        $slide_content_style .= "box-shadow: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide_text_content_box_shaddow", true)) . ";";
                    }
					
					$slide_content_inner_shaddow="";
					if (get_post_meta(get_the_ID(), "qode_slide_content_graphic_box_shaddow", true) != "") {
                        $slide_content_inner_shaddow .= "box-shadow: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide_content_graphic_box_shaddow", true)) . ";";
                    }
					
					$slide_content_inner_background="";
					if (get_post_meta(get_the_ID(), "qode_slide_content_graphic_background", true) != "") {
                        $slide_content_inner_background .= "background-color: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide_content_graphic_background", true)) . ";";
                    }
					...
					$slide_graphic_style = "";
                    if (get_post_meta(get_the_ID(), "qode_slide_graphic_background", true) != "") {
                        $slide_graphic_style .= "background-color: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide_graphic_background", true)) . ";";
                    }
					if (get_post_meta(get_the_ID(), "qode_slide_graphic_top_padding", true) != "") {
                        $slide_graphic_style .= "padding-top: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide_graphic_top_padding", true)) . "px;";
                    }
					if (get_post_meta(get_the_ID(), "qode_slide_graphic_bottom_padding", true) != "") {
                        $slide_graphic_style .= "padding-bottom: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide_graphic_bottom_padding", true)) . "px;";
                    }
                    $slide_title_style = "";
                    ...
                    if (get_post_meta(get_the_ID(), 'qode_slide-title-background-color', true) !== '') {
                        ...
                        $slide_title_span_style .= 'background-color: ' . esc_attr(qode_pitch_rgba_color($slide_title_bg_color, $slide_title_bg_transparency)) . ';';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-separator-title", true) == 'yes') {
                        ...
                        if ($slide_separator_type_var == "without_icon") {
                            ...
                            if ($slide_separator_color !== '') {
                                ...
                                if ($slide_separator_transparency !== '') {
                                    ...
                                    $slide_separator_rgba_color = qode_pitch_rgba_color($slide_separator_color, $slide_separator_transparency);
                        ...
                        if (get_post_meta(get_the_ID(), "qode_slide_title_separator_type", true) == "with_icon") {
                            ...
                            if (get_post_meta(get_the_ID(), "qode_slide_title_separator_with_icon_icon_pack", true) != ''){
                                ...
                                $slide_separator_icon_param = $qode_pitch_IconCollections->getIconCollection($slide_separator_icon);
                    ...
                    if (get_post_meta(get_the_ID(), 'qode_slide-subtitle-background-color', true) !== '') {
                        ...
                        $slide_subtitle_span_style .= 'background-color: ' . esc_attr(qode_pitch_rgba_color($slide_subtitle_bg_color, $slide_subtitle_bg_transparency)) . ';';
                    }
                    ...
                    if ($slide_text_separator_var == "no") {
                        ...
                        if (get_post_meta(get_the_ID(), 'qode_slide-text-background-color', true) !== '') {
                            ...
                            $slide_text_span_style .= 'background-color: ' . esc_attr(qode_pitch_rgba_color($slide_text_bg_color, $slide_text_bg_transparency)) . ';';
                        }
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide_predefined_content_position_width_fs", true) !== "") {
                        $slide_data_content_resize = 'data-resize = '.esc_attr(get_post_meta(get_the_ID(), "qode_slide_predefined_content_position_width_fs", true));
                    }
                    ...
                    if ($slide_type == 'video') {
                        ...
                        $html .= '<div class="video"><div class="mobile-video-image" '.qode_pitch_get_inline_style('background-image: url(' . esc_url($video_image) . ')').'></div><div class="video-overlay';
                        ...
                        $html .= '<div class="image" '.qode_pitch_get_inline_style('background-image:url(' . esc_url($image) . ')').'>';
                        if ($slider_thumbs == 'no') {
                            $html .= '<img src="' . esc_url($image) . '" alt="' . esc_attr($title) . '">';
                        }

                        if ($image_overlay_pattern !== "") {
                            $html .= '<div class="image_pattern" '.qode_pitch_get_inline_style('background: url(' . esc_url($image_overlay_pattern) . ') repeat 0 0').'></div>';
                        }
                        $html .= '</div>';
                    }
                    ...
                    $html_thumb = "";
                    if ($thumbnail != "") {
                        $html_thumb .= '<div style="' . esc_attr($slide_graphic_style) . '" '.$slide_graphics_data.'>';
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-subtitle", true) != "") {
                        ...
                        $html_text .= '<h3 class="q_slide_subtitle" '.qode_pitch_get_inline_style($slide_subtitle_style).'><span '.qode_pitch_get_inline_style($slide_subtitle_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), 'qode_slide-subtitle', true)) . '</span></h3>';
                        $html_text .= '</div></div>';
                    }
                    ...
                    if ((get_post_meta(get_the_ID(), "qode_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'bottom' ) && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.qode_pitch_get_inline_style($slide_separator_styles.$slide_top_separator_styles).' class="separator separator_top"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-hide-title", true) != true) {
                        ...
                        $html_text .= '<h2 class="q_slide_title" '.qode_pitch_get_inline_style($slide_title_style).'>';
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<span '.qode_pitch_get_inline_style($slide_separator_styles.$slide_left_separator_margin).' class="separator separator_left"><span class="slide_separator_dots" '.qode_pitch_get_inline_style($slide_dots_style).'></span></span>';
                        }
                        if (get_post_meta(get_the_ID(), "qode_slide-title-link", true) != '') {
                            $html_text .= '<a '.qode_pitch_get_inline_style($slide_title_style).' '.$slide_title_data.' href="' . esc_url(get_post_meta(get_the_ID(), "qode_slide-title-link", true)) . '" target="' . esc_attr(get_post_meta(get_the_ID(), "qode_slide-title-target", true)) . '">';
                        }
                        $html_text .= '<span '.qode_pitch_get_inline_style($slide_title_span_style).'>' . wp_kses_post(get_the_title()) . '</span>';
                        if (get_post_meta(get_the_ID(), "qode_slide-title-link", true) != '') {
                            $html_text .= '</a>';
                        }
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<span '.qode_pitch_get_inline_style($slide_separator_styles.$slide_right_separator_margin).' class="separator separator_right"><span class="slide_separator_dots" '.qode_pitch_get_inline_style($slide_dots_style).'></span></span>';
                        }
                    ...
                    if ((get_post_meta(get_the_ID(), "qode_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'top') && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.qode_pitch_get_inline_style($slide_separator_styles.$slide_bottom_separator_styles).'  class="separator separator_bottom"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-text", true) != "") {
                        ...
                        if ($slide_text_separator_var == 'yes') {
                            ...
                            $html_text .= '<h3 class="q_slide_text" '.qode_pitch_get_inline_style($slide_text_style).'><span '.qode_pitch_get_inline_style($slide_text_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), "qode_slide-text", true)) . '</span></h3>';
                        }
                        $html_text .= '</div></div>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-button_background_hover_color", true) != "" && get_post_meta(get_the_ID(), "qode_slide-button1_hover_button_animation", true) == '' ) {
                        $data_attr1 .= "data-hover-background-color=" . esc_attr(get_post_meta(get_the_ID(), "qode_slide-button_background_hover_color", true)) . " ";
                    }
					if (get_post_meta(get_the_ID(), "qode_slide-button_background_hover_color", true) != "" && get_post_meta(get_the_ID(), "qode_slide-button1_hover_button_animation", true) !== '' ) {
                        $data_attr1 .= "data-hover-animated-background-color=" . esc_attr(get_post_meta(get_the_ID(), "qode_slide-button_background_hover_color", true)) . " ";
                    }
                    ...
                    if ($is_first_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), 'button1_icon_pack', true) !== 'no_icon') {
                            $first_btn_icon_collection = $qode_pitch_IconCollections->getIconCollection(get_post_meta(get_the_ID(), 'button1_icon_pack', true));
						...
						$span='';
						$first_button_class='';
						if(get_post_meta(get_the_ID(), "qode_slide-button1_hover_button_animation", true) !== '') {
                            $first_button_class = esc_attr(get_post_meta(get_the_ID(), "qode_slide-button1_hover_button_animation", true));
							$span='<span class="a_overlay"></span>';
                        }
						
                        $html_text .= '<a class="qbutton '.esc_attr($first_button_icon_class) . esc_attr($first_button_class).'" ' . $data_attr1 . ' '.qode_pitch_get_inline_style($button_text_style1).' '.$slide_button_1_data.' href="' . esc_url(get_post_meta(get_the_ID(), "qode_slide-button-link", true)) . '" target="' . esc_attr($slide_button_target) . '"><span class="text_wrap">' . esc_html(get_post_meta(get_the_ID(), "qode_slide-button-label", true)) . '</span>' . $first_button_icon_html . $span .'</a>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-button_background_hover_color2", true) != "" && get_post_meta(get_the_ID(), "qode_slide-button2_hover_button_animation", true) == '') {
                        $data_attr2 .= "data-hover-background-color=" . esc_attr(get_post_meta(get_the_ID(), "qode_slide-button_background_hover_color2", true)) . " ";
                    }
					if (get_post_meta(get_the_ID(), "qode_slide-button_background_hover_color2", true) != "" && get_post_meta(get_the_ID(), "qode_slide-button2_hover_button_animation", true) !== '' ) {
                        $data_attr2 .= "data-hover-animated-background-color=" . esc_attr(get_post_meta(get_the_ID(), "qode_slide-button_background_hover_color2", true)) . " ";
                    }
                    ...
                    if ($is_second_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), 'button2_icon_pack', true) !== 'no_icon') {
                            $second_btn_icon_collection = $qode_pitch_IconCollections->getIconCollection(get_post_meta(get_the_ID(), 'button2_icon_pack', true));
						...
						$span2='';
						$second_button_class='';
						if(get_post_meta(get_the_ID(), "qode_slide-button2_hover_button_animation", true) !== '') {
                            $second_button_class = esc_attr(get_post_meta(get_the_ID(), "qode_slide-button2_hover_button_animation", true));
							$span2='<span class="a_overlay"></span>';
                        }
						
                        $html_text .= '<a class="qbutton '.esc_attr($second_button_icon_class) . esc_attr($second_button_class). '" ' . $data_attr2 . ' '.qode_pitch_get_inline_style($button_text_style2).' '.$slide_button_2_data.' href="' . esc_url(get_post_meta(get_the_ID(), "qode_slide-button-link2", true)) . '" target="' . esc_attr($slide_button_target2) . '"><span class="text_wrap">' . esc_html(get_post_meta(get_the_ID(), "qode_slide-button-label2", true)) . '</span>' . $second_button_icon_html . $span2 .  '</a>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-anchor-button", true) !== '') {
                        ...
                        if(get_post_meta(get_the_ID(), "qode_slide-anchor-button_position", true) == 'in_content' || get_post_meta(get_the_ID(), "qode_slide-anchor-button_position", true) == ''){
                            $slide_anchor_classes .= 'el slider_anchor_in_content';
                        }
                        elseif(get_post_meta(get_the_ID(), "qode_slide-anchor-button_position", true) == 'bottom_of_slider'){
                            $slide_anchor_classes .= 'slider_anchor_on_bottom_of_the_slider';
                        }

                        $html_slider_anchor = '<div class="slide_anchor_holder '.esc_attr($slide_anchor_classes).'"><a ' . $slide_anchor_style . ' class="slide_anchor_button anchor" href="' . esc_url(get_post_meta(get_the_ID(), "qode_slide-anchor-button", true)) . '"><i class="fa fa-angle-down"></i></a></div>';
                    }

                    if($html_slider_anchor != '' && (get_post_meta(get_the_ID(), "qode_slide-anchor-button_position", true) == 'in_content' || get_post_meta(get_the_ID(), "qode_slide-anchor-button_position", true) == '')){
                    ...
                    if ($separate_text_graphic != 'yes') {
                        $html .= '<div class="slider_content ' . esc_attr($content_alignment) .'" '.qode_pitch_get_inline_style($content_width . $content_xaxis . $content_yaxis_start).' '.$slide_data_start.' '.$slide_data_end.' '.$slide_data_content_resize.'>';
							if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
								$html .= '<div class="slider_content_inner ' . esc_attr($content_animation . ' ' . $content_animation_direction) .'" '.qode_pitch_get_inline_style($vertical_content_width . $vertical_content_xaxis . $slide_content_inner_shaddow . $slide_content_inner_background).'>';
							}
							$html .= $html_thumb;
							$html .= $html_text;
							if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
                            ...
                            if($html_slider_anchor != '' && get_post_meta(get_the_ID(), "qode_slide-anchor-button_position", true) == 'bottom_of_slider'){
                                $html .= $html_slider_anchor;
                            }
                        $html .= '</div>';
                    } else {
                        $html .= '<div class="slider_content graphic_content ' . esc_attr($graphic_alignment) . '" '.qode_pitch_get_inline_style($graphic_width . $graphic_xaxis . $graphic_yaxis_start).'>';
							if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
								$html .= '<div class="slider_content_inner" '.qode_pitch_get_inline_style($vertical_content_width . $vertical_content_xaxis . $slide_content_inner_shaddow . $slide_content_inner_background).'>';
							}
							$html .= $html_thumb;
							if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
								$html .= '</div>';
                ...
                $html .= esc_html__('Sorry, no slides matched your criteria.', 'qode_core');
            endif;
            wp_reset_query();
            ...
            if ($found_slides > 1) {
                if ($show_navigation_circles == "yes") {
                    ...
                    $triangle_bkg='';
                    if(isset($qode_pitch_options['enable_slider_triangle']) && $qode_pitch_options['enable_slider_triangle'] == 'yes') {
                    ...
                    if (have_posts()) : $postCount = 0;
                        ...
                        $html .= esc_html__('Sorry, no posts matched your criteria.', 'qode_core');
                    endif;
                ...
                if ($show_navigation_arrows == "yes") {
                    ...
                    if (isset($qode_pitch_options['navigation_arrows_type']) && $qode_pitch_options['navigation_arrows_type'] != '') {
                        $icon_navigation_class = $qode_pitch_options['navigation_arrows_type'];
                    }
            ...
            $html .= '</div>';
            if($qode_pitch_options['paspartu'] == 'yes' && $qode_pitch_options['paspartu_on_bottom_slider'] == 'yes') {
                $html .= '<div class="qode_slider_bottom_paspartu"></div>';
            }
        }
